...
$incomeStatement = $study->incomeStatement;
		 ...
		 */
		$yearIndexWithLastMonth = HArr::getLastMonthOfYear($yearWithItsMonths);
		$portfolioLoanOutstandingOpeningBalance = DB::connection(PROPERTY_MANAGEMENT_CONNECTION_NAME)->table('supplier_payable_opening_balances')->where('study_id', $study->id)->first();
        ...
        return view('property_managements.income-statement.valuation',[
			'company'=>$company ,
			'study'=>$study , 
			'model'=>$study ,
			'title'=>$title,
