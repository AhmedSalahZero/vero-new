...
use App\Models\PropertyManagement\ForeignExchangeRate;
...
class ForeignExchangeRateController
{
    ...
    public function index(Company $company, Request $request, $returnIndexArray = false)
    {
        ...
        $activeType = $request->input('active', $mainFunctionalCurrency) ;
        $filterDates = [];
        $searchFields = [];
        $models = [];
        $existingCurrencies =['USD','EURO'];
        ...
        return view('property_managements.foreign-exchange-rate.foreign-exchange-rate', $viewDataArray);
    }
    public function store(Request $request, Company $company)
    {
        ...
        return redirect()->route('view.property.management.foreign.exchange.rate', ['company'=>$company->id,'active'=>$request->get('from_currency')]);
    }
    public function edit(Request $request, Company $company, $foreignExchangeRateId)
    {
        ...
        return view('property_managements.foreign-exchange-rate.foreign-exchange-rate', array_merge($indexViewData, [
            'company'=>$company,
    ...
    public function destroy(Request $request, Company $company, $foreignExchangeRateId)
    {
        ...
        // }
        return redirect()->route('view.property.management.foreign.exchange.rate', ['company'=>$company->id]);
    }
