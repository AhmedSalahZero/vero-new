...
class NewBranchesMicrofinanceController extends Controller
{
    ...
    {
		$rightOfUseRent = $request->input('right_of_use_rent.0',[]);
		$study->update([
			'right_of_use_rent'=>$rightOfUseRent
		]);
		...
		$study->calculateRightOfUseRentAndStatement();
