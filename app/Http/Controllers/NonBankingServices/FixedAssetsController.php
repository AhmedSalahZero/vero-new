...
class FixedAssetsController extends Controller
{
    ...
    protected function getViewVars(Company $company, Study $study)
    {
        ...
        return [
            ...
            'storeRoute'=>route('non.banking.store.ffe.fixed.assets', ['company'=>$company->id , 'study'=>$study->id]),
    ...
    public function getOldData(Company $company, Request $request, Study $study)
    {
        ...
        return [
            ...
            'submitUrl'=>route('non.banking.store.ffe.fixed.assets', ['company'=>$company->id , 'study'=>$study->id]),
            'dates'=>(object)$dates,
