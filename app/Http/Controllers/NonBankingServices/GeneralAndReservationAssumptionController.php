...
class GeneralAndReservationAssumptionController extends Controller
{
	...
	public function getOldData(Company $company , Request $request , Study $study)
	{
		...
		return [
			'submitUrl'=>route('non.banking.store.general.assumption',['company'=>$company->id , 'study'=>$study->id]),
			'dates'=>(object)$dates,
			...
			'model'=>[
				...
				'cbe_corridor_changes_rates'=>$cbeCorridorChangesRates,
				'cbe_base_lending_corridor_rates'=>$cbeBaseLendingCorridorRates,
