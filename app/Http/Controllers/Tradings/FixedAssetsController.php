...
use App\Models\Trading\FixedAsset;
...
class FixedAssetsController extends Controller
{
    ...
    {
        return view('tradings.ffe-fixed-assets.form', $this->getViewVars($company, $study));
    }
    public function createFundingStructure(Company $company, Request $request, Study $study)
    {
        return view('tradings.ffe-fixed-assets.funding-form', $this->getViewVars($company, $study));
    }
    protected function getViewVars(Company $company, Study $study)
    {
        ...
        return [
            ...
            'storeRoute'=>route('trading.store.ffe.fixed.assets', ['company'=>$company->id , 'study'=>$study->id]),
    ...
    public function getOldData(Company $company, Request $request, Study $study)
    {
        ...
        return [
            ...
            'submitUrl'=>route('trading.store.ffe.fixed.assets', ['company'=>$company->id , 'study'=>$study->id]),
            'dates'=>(object)$dates,
