...
use App\Models\Trading\LongTermLoanOpeningBalance;
use App\Models\Trading\OtherCreditsOpeningBalance;
use App\Models\Trading\OtherDebtorsOpeningBalance;
use App\Models\Trading\OtherLongTermAssetsOpeningBalance;
use App\Models\Trading\OtherLongTermLiabilitiesOpeningBalance;
...
class OpeningBalancesController extends Controller
{
    ...
    {
        return view('tradings.openingBalances.form', array_merge($study->getOpeningBalancesViewVars(), ['inEditMode'=>false]));
    }
    ...
    public function store(Company $company, StoreOpeningBalancesRequest $request, Study $study)
    {
        ...
        DB::connection(TRADING_CONNECTION_NAME)->table('cashflow_statement_reports')->where('study_id', $study->id)->update([
        ...
        DB::connection(TRADING_CONNECTION_NAME)->table('income_statement_reports')->where('study_id', $study->id)->update([
        ...
        return redirect()->route('view.trading.forecast.income.statement', ['company'=>$company->id,'study'=>$study->id]);
