...
trait HasBalances 
{
	public static function formatForStatementReport(Collection $invoices,int $partnerId,string $startDate,string $endDate,string $currency,string $modelType){
		...
		$invoicesForBeginningBalance = $fullClassName::getInvoicesForInvoiceStartAndEndDate( $clientIdColumnName, $partnerId, app(Company::class) ,  $currency ,  $oneDayBeforeStartDate,$startDateMinusOne );
		$formattedData = [];
