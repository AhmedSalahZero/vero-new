    ...
    public static function boot()
    {
        ...
        static::saving(function (self $model) {
            ...
            // if (!$study->isMonthlyStudy()) {
                ...
                $model->existing_cases = HArr::repeatLastValueInArrayUntil($model->existing_cases?:[], $studyEndDateAsIndex) ;
                $model->new_cases = HArr::repeatLastValueInArrayUntil($model->new_cases?:[], $studyEndDateAsIndex) ;
            // }
