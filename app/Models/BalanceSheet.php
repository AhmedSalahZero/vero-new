...
class  BalanceSheet extends Model implements  IHaveAllRelations, IExportable, IShareable, IFinancialStatementAble
{
	...
	public static function getReportViewVars(array $options = []): array
	{
		...
		return [
			...
			'interval' => HVero::getIntervalForSelect($options['balanceSheet']->getDurationType()),
