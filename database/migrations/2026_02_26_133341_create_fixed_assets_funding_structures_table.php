...
return new class extends Migration
{
    ...
    {
        Schema::connection('property_management')->create('fixed_assets_funding_structures', function (Blueprint $table) {
    ...
    {
        Schema::connection('property_management')->dropIfExists('fixed_assets_funding_structures');
    }
};
