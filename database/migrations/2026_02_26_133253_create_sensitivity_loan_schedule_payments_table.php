...
return new class extends Migration
{
    ...
    {
        Schema::connection('non_banking_service')->create('sensitivity_loan_schedule_payments', function (Blueprint $table) {
    ...
    {
        Schema::connection('non_banking_service')->dropIfExists('sensitivity_loan_schedule_payments');
    }
};
