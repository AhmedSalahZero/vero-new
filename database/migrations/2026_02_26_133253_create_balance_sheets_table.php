...
return new class extends Migration
{
    ...
    {
        Schema::connection('non_banking_service')->create('balance_sheets', function (Blueprint $table) {
            ...
            $table->timestamps();
            $table->json('monthly_long_term_investments')->nullable();
            $table->json('yearly_long_term_investments')->nullable();
        });
    }
    ...
    {
        Schema::connection('non_banking_service')->dropIfExists('balance_sheets');
    }
};
