...
return new class extends Migration
{
    ...
    {
        DB::unprepared("CREATE DEFINER=`root`@`localhost` PROCEDURE `start_settlement_process_fully_secured_overdraft`(in _type varchar(255) ,in _bank_statement_id integer , in _fully_secured_overdraft_id integer , in _debit decimal , in _credit decimal , in _company_id integer , in _date_for_settlement date)
begin 
