...
class CreateFinancialPlanningStudiesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::connection(FINANCIAL_PLANNING_CONNECTION_NAME)->create('studies', function (Blueprint $table) {
            $table->id();
			...
			$table->decimal('ebitda_multiplier',14,2)->default(0);
