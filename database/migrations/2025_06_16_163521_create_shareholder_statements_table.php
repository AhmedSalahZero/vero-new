...
class CreateShareholderStatementsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('other_partner_statements', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('partner_id')->index('other_partner_statements_partner_id_foreign');
    ...
    {
        Schema::dropIfExists('other_partner_statements');
    }
}
