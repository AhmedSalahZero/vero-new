...
class CreateDirectFactoringNewPortfolioFundingStructuresTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::connection('non_banking_service')->create('direct_factoring_new_portfolio_funding_structures', function (Blueprint $table) {
			$table->id();
