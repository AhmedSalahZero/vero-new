...
return new class extends Migration
{
    ...
    {
        Schema::connection('non_banking_service')->create('income_statements', function (Blueprint $table) {
    ...
    {
        Schema::connection('non_banking_service')->dropIfExists('income_statements');
    }
};
