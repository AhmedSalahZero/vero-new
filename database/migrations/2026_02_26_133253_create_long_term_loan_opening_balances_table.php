...
return new class extends Migration
{
    ...
    {
        Schema::connection('non_banking_service')->create('long_term_loan_opening_balances', function (Blueprint $table) {
    ...
    {
        Schema::connection('non_banking_service')->dropIfExists('long_term_loan_opening_balances');
    }
};
