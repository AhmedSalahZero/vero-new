...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('quick_pricing_calculators', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('revenue_business_line_id')->index('quick_pricing_calculators_revenue_business_line_id_foreign');
            $table->unsignedBigInteger('service_category_id')->index('quick_pricing_calculators_service_category_id_foreign');
            $table->unsignedBigInteger('service_item_id')->index('quick_pricing_calculators_service_item_id_foreign');
            $table->unsignedBigInteger('service_nature_id')->index('quick_pricing_calculators_service_nature_id_foreign');
            ...
            $table->unsignedBigInteger('company_id')->index('company_id_quick_pricing_calculators');
            $table->unsignedBigInteger('creator_id')->nullable()->index('creator_id_quick_pricing_calculators');
            $table->timestamps();
        });
    }
