...
return new class extends Migration
{
    ...
    {
        Schema::connection('non_banking_service')->create('supplier_payable_opening_balances', function (Blueprint $table) {
    ...
    {
        Schema::connection('non_banking_service')->dropIfExists('supplier_payable_opening_balances');
    }
};
