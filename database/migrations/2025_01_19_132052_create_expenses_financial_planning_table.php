...
class CreateExpensesFinancialPlanningTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::connection(FINANCIAL_PLANNING_CONNECTION_NAME)->create('expenses', function (Blueprint $table) {
            $table->increments('id');
