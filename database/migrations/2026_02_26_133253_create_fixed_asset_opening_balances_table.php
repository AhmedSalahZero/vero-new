...
return new class extends Migration
{
    ...
    {
        Schema::connection('non_banking_service')->create('fixed_asset_opening_balances', function (Blueprint $table) {
    ...
    {
        Schema::connection('non_banking_service')->dropIfExists('fixed_asset_opening_balances');
    }
};
