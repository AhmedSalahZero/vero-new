...
return new class extends Migration
{
    ...
    {
        Schema::create('shareholder_statements', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('partner_id')->index('shareholder_statements_partner_id_foreign');
    ...
    {
        Schema::dropIfExists('shareholder_statements');
    }
};
