...
<template>
  <div
    class="mp-create-root"
    :data-current-company-id="company.id"
    :data-lang="$page?.props?.locale || 'en'"
  >
    ...
    <div class="row">
      <div class="col-md-12">
        <form method="post" :action="formAction" class="kt-form kt-form--label-right">
          ...
          <input type="hidden" id="ajax-invoice-item" :data-single-model="singleModel ? 1 : 0" :value="singleModel || 0" />
            ...
            <div class="kt-portlet__body">
              <div class="form-group row">
                  ...
                  <div class="kt-input-icon">
                    <div class="input-group date">
                      <select required name="partner_type" id="partner_type" class="form-control">
                        <option v-for="pt in partnerTypes" :key="pt.type" :value="pt.type" :selected="model?.partnerType === pt.type">
                          {{ pt.title }}
                        </option>
                      </select>
                    </div>
                ...
                <div class="col-md-1" id="invoice-currency-div-id">
                  <label class="text-nowrap">Invoice Currency <span class="text-danger required-label">*</span></label>
                  <div class="kt-input-icon">
                    <div class="input-group date">
                      <select
                      ...
                      >
                        <option v-for="c in invoiceCurrencies" :key="c.id" :value="c.id" :selected="c.selected">{{ c.label }}</option>
                      </select>
                    </div>
                  </div>
                </div>
                <div class="col-md-3">
                  ...
                  <div class="kt-input-icon">
                    <div class="kt-input-icon">
                      <div class="input-group date">
                        <select
                          :data-current-selected="model?.supplierName ?? ''"
                        ...
                        >
                          ...
                          <option v-for="s in suppliers" :key="s.id" :value="s.id" :selected="!!s.selected || (!!singleModel && !isEdit)">
                            {{ s.name }}
                          </option>
                        </select>
                      </div>
                ...
                <div class="col-md-1">
                  <label class="text-nowrap">Pay Currency <span class="text-danger required-label">*</span></label>
                  <div class="kt-input-icon">
                    <div class="input-group date">
                      <select
                        id="receiving-currency-id"
                        when-change-trigger-account-type-change
                      ...
                      >
                        <option v-for="c in paymentCurrencies" :key="c.id" :value="c.id" :selected="c.selected">{{ c.label }}</option>
                      </select>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="kt-input-icon">
                    <div class="input-group date">
                      <select required name="type" id="type" class="form-control">
                        <option value="" selected>Select</option>
                        <option :value="MP.CASH_PAYMENT" :selected="model?.isCashPayment">Cash Payment</option>
                        <option :value="MP.PAYABLE_CHEQUE" :selected="model?.isPayableCheque">Payable Cheques</option>
                        <option :value="MP.OUTGOING_TRANSFER" :selected="model?.isOutgoingTransfer">Outgoing Transfer</option>
                      </select>
                    </div>
                  </div>
                </div>
                <div class="col-md-2" data-current-selected="" id="transaction-type-parent">
                  ...
                  <div class="kt-input-icon">
                    <div class="input-group date">
                      <select required name="transaction_type" id="transaction_type" class="form-control"></select>
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <div class="col-md-3 mb-3">
                    ...
                    <div class="kt-input-icon">
                      <input
                        ...
                        type="text"
                        disabled
                        class="form-control cash-balance-js"
              ...
              <div class="form-group">
                <div class="row">
                  <div class="col-md-5 width-40">
                    ...
                    <div class="kt-input-icon">
                      <div class="input-group date">
                        ...
                        >
                          <option v-for="b in selectedBranches" :key="b.id" :value="b.id" :selected="model?.cashPaymentBranchId === b.id">
                            {{ b.name }}
                          </option>
                        </select>
                      </div>
                  ...
                  <div class="col-md-2 closest-parent">
                    <label>Paid Amount <span class="currency-span"></span> <span class="text-danger required-label">*</span></label>
                    <div class="kt-input-icon">
                      <input
                        :data-current-value="model?.paidAmount ?? 0"
                        data-max-cheque-value="0"
                        type="text"
                        :value="model?.paidAmount ?? 0"
                      ...
                      />
                      <span
                        class="kt-input-icon__icon kt-input-icon__icon--right col-md-6"
                        tabindex="0"
                        role="button"
                        data-toggle="kt-popover"
                        data-trigger="focus"
                        data-html="true"
                        data-content="Kash Vero"
                      >
                  ...
                  <div class="col-md-3 width-12">
                    ...
                    <div class="kt-input-icon">
                      <input
                        type="text"
                        name="receipt_number"
                        :value="model?.cashPaymentReceiptNumber ?? ''"
                        class="form-control"
                  ...
                  <div class="col-md-2 width-12 show-only-when-invoice-currency-not-equal-receiving-currency">
                    ...
                    <div class="kt-input-icon">
                      <input
                        :data-current-value="model?.exchangeRate ?? 1"
                        :value="model?.exchangeRate ?? 1"
                        placeholder="Exchange Rate"
                        type="text"
                        :name="'exchange_rate[' + MP.CASH_PAYMENT + ']'"
                  ...
                  <div class="col-md-3 mt-4 show-only-when-invoice-currency-not-equal-receiving-currency hidden">
                    <label>Amount In Invoice Currency <span class="text-danger required-label">*</span></label>
                    <div class="kt-input-icon">
                      <input
                        readonly
                        :value="0"
          ...
          <div class="kt-portlet js-section-parent hidden mp-card" :id="MP.PAYABLE_CHEQUE">
            <div class="kt-portlet__head">
              <div class="kt-portlet__head-label flex-1">
                <h3 class="kt-portlet__head-title head-title text-primary">Payable Cheque Information</h3>
                <div class="flex-1 d-flex justify-content-end pt-3">
                  <div class="col-md-3 mb-3">
                    <label>Balance <span class="balance-date-js"></span></label>
                    <div class="kt-input-icon">
                      <input value="0" type="text" disabled class="form-control balance-js" placeholder="Account Balance" />
                    </div>
                  </div>
                  <div class="col-md-3 mb-3">
                    <label>Net Balance <span class="net-balance-date-js"></span></label>
                    <div class="kt-input-icon">
                      <input value="0" type="text" disabled class="form-control net-balance-js" placeholder="Net Balance" />
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="form-group">
                <div class="row">
                  <div class="col-md-6 mb-3">
                    ...
                    <div class="kt-input-icon">
                      <div class="input-group date">
                        ...
                        >
                          <option v-for="(fib, i) in financialInstitutionBanks" :key="i" :value="fib.id" :selected="model?.payableChequePaymentBankId === fib.id">
                            {{ fib.name }}
                          </option>
                        </select>
                      </div>
                  ...
                  <div class="col-md-3">
                    ...
                    <div class="kt-input-icon">
                      <div class="input-group date">
                        <select :name="'account_type[' + MP.PAYABLE_CHEQUE + ']'" class="form-control js-update-account-number-based-on-account-type">
                          <option value="" selected>Select</option>
                          <option v-for="(at, ai) in accountTypes" :key="ai" :value="at.id" :selected="model?.payableChequeAccountTypeId === at.id">
                            {{ at.name }}
                          </option>
                        </select>
                      </div>
                  ...
                  <div class="col-md-2 width-12">
                    ...
                    <div class="kt-input-icon">
                      <div class="input-group date">
                        <select
                          :data-current-selected="model?.payableChequeAccountNumber ?? 0"
                  ...
                  <div class="col-md-3 closest-parent">
                    <label>Cheque Amount <span class="currency-span"></span> <span class="text-danger required-label">*</span></label>
                    <div class="kt-input-icon">
                      <input
                        data-max-cheque-value="0"
                        :value="model?.paidAmount ?? 0"
                        placeholder="Please insert the cheque amount"
                        type="text"
                  ...
                  <div class="col-md-3">
                    ...
                    <div class="kt-input-icon">
                      <div class="input-group date">
                        <input
                          type="text"
                          :value="model?.payableChequeDueDateFormatted ?? ''"
                          name="due_date"
                          class="form-control is-date-css"
                          readonly
                          placeholder="Select date"
                          id="kt_datepicker_2"
                        />
                  ...
                  <div class="col-md-3">
                    ...
                    <div class="kt-input-icon">
                      <input
                        type="text"
                        name="cheque_number"
                        :value="model?.payableChequeNumber ?? 0"
                        class="form-control"
                  ...
                  <div class="col-md-2 width-12 show-only-when-invoice-currency-not-equal-receiving-currency">
                    ...
                    <div class="kt-input-icon">
                      <input
                        ...
                        placeholder="Exchange Rate"
                        type="text"
                        :name="'exchange_rate[' + MP.PAYABLE_CHEQUE + ']'"
                        class="form-control only-greater-than-or-equal-zero-allowed exchange-rate-class recalculate-amount-class"
                        :data-type="MP.PAYABLE_CHEQUE"
                      />
                    </div>
                  ...
                  <div class="col-md-3 mt-4 show-only-when-invoice-currency-not-equal-receiving-currency hidden closest-parent">
                    <label>Amount In Invoice Currency <span class="currency-span"></span> <span class="text-danger required-label">*</span></label>
                    <div class="kt-input-icon">
                      <input
                        readonly
                        :value="0"
          ...
          <div class="kt-portlet js-section-parent hidden mp-card" :id="MP.OUTGOING_TRANSFER">
            <div class="kt-portlet__head">
              <div class="kt-portlet__head-label flex-1">
                <h3 class="kt-portlet__head-title head-title text-primary">Outgoing Transfer Information</h3>
                <div class="flex-1 d-flex justify-content-end pt-3">
                  <div class="col-md-3 mb-3">
                    <label>Balance <span class="balance-date-js"></span></label>
                    <div class="kt-input-icon">
            ...
            <div class="kt-portlet__body">
              <div class="form-group">
                <div class="row">
                  <div class="col-md-5 width-40">
                    <label><span v-html="'Payment <br> Bank'"></span> <span class="text-danger required-label">*</span></label>
                    <div class="kt-input-icon">
                      <div class="input-group date">
                        <select
                          js-when-change-trigger-change-account-type
                          ...
                          class="form-control financial-institution-id"
                        >
                          <option v-for="(fib, i) in financialInstitutionBanks" :key="'ot-' + i" :value="fib.id" :selected="model?.outgoingTransferDeliveryBankId === fib.id">
                            {{ fib.name }}
                          </option>
                        </select>
                      </div>
                  ...
                  <div class="col-md-3">
                    <label><span v-html="'Account <br> Type'"></span> <span class="text-danger required-label">*</span></label>
                    <div class="kt-input-icon">
                      <div class="input-group date">
                        <select :name="'account_type[' + MP.OUTGOING_TRANSFER + ']'" class="form-control js-update-account-number-based-on-account-type">
                          <option value="" selected>Select</option>
                          <option v-for="(at, ai) in accountTypes" :key="'ota-' + ai" :value="at.id" :selected="model?.outgoingTransferAccountTypeId === at.id">
                            {{ at.name }}
                          </option>
                        </select>
                      </div>
                  ...
                  <div class="col-md-2 width-12">
                    <label><span v-html="'Account <br> Number'"></span> <span class="text-danger required-label">*</span></label>
                    <div class="kt-input-icon">
                      <div class="input-group date">
                        <select
                  ...
                  <div class="col-md-2 max-w-15 closest-parent">
                    <label
                      ><span v-html="'Outgoing <br> Transfer Amount'"></span> <span class="currency-span"></span>
                  ...
                  <div class="col-md-3 mt-4 show-only-when-invoice-currency-not-equal-receiving-currency">
                    ...
                    <div class="kt-input-icon">
                      <input
                        ...
                        placeholder="Exchange Rate"
                        type="text"
                        :name="'exchange_rate[' + MP.OUTGOING_TRANSFER + ']'"
                        class="form-control only-greater-than-or-equal-zero-allowed exchange-rate-class recalculate-amount-class"
                        :data-type="MP.OUTGOING_TRANSFER"
                      />
                    </div>
          ...
          <template v-if="showSettlementBlock">
            <div class="kt-portlet mp-card" id="settlement-card-id">
              <div class="kt-portlet__head">
                <div class="kt-portlet__head-label">
                  <h3 class="kt-portlet__head-title head-title text-primary">Settlement Information</h3>
                </div>
              </div>
              <div class="kt-portlet__body">
                    ...
                    <div class="kt-margin-b-10 border-class">
                      <div class="form-group row align-items-end settlement-row-parent">
                          ...
                          <div class="kt-input-icon">
                            <div class="kt-input-icon">
                              <div class="input-group date">
                                ...
                                <input
                                  readonly
                                  class="form-control js-invoice-number"
                                  data-invoice-id="0"
                                  name="settlements[][invoice_number]"
                                  value="0"
                                />
                              </div>
                            </div>
                        ...
                        <div class="col-md-1 width-9-5">
                          ...
                          <div class="kt-input-icon">
                            <input
                              name="settlements[][settlement_amount]"
                              placeholder=""
                              type="text"
                        ...
                        <div class="col-md-1 width-9-5">
                          ...
                          <div class="kt-input-icon">
                            <input
                              name="settlements[][withhold_amount]"
                              placeholder=""
                              type="text"
                        ...
                        <div class="col-md-1">
                          ...
                          <div class="modal fade modal-class-js allocate-modal-class" id="add-new-customer-modal--0" tabindex="-1" role="dialog" aria-hidden="true">
                              ...
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                  <div class="form-group row justify-content-center">
                                    <div class="col-md-12 show-class-js js-parent-to-table" data-table-id="m_repeater--0">
                                      <table id="m_repeater--0" class="table m_repeater--0 table-white repeater-class repeater allocations">
                                        <thead>
                                          <tr>
                                            <th class="form-label font-weight-bold text-center align-middle col-md-1 action-class">+/-</th>
                                            <th class="form-label font-weight-bold text-center align-middle th-main-color">Customer</th>
                                            <th class="form-label font-weight-bold text-center align-middle th-main-color">Contract Name</th>
                                            <th class="form-label font-weight-bold text-center align-middle th-main-color">Contract Code</th>
                                            <th class="form-label font-weight-bold text-center align-middle th-main-color">Contract Amount</th>
                                            <th class="form-label font-weight-bold text-center align-middle th-main-color">Allocate Amount</th>
                                          </tr>
                                        </thead>
                                        <tbody data-repeater-list="allocations">
                                          <tr data-repeater-item>
                                            <td class="text-center">
                                              ...
                                              <div class="">
                                                <i data-repeater-delete="" class="btn-sm btn btn-danger m-btn m-btn--icon m-btn--pill trash_icon fas fa-times-circle"></i>
                                              </div>
                                            </td>
                                            <td>
                                              <select
                                        ...
                                        <td>
                                          <div data-repeater-create="" class="btn btn btn-sm text-white add-row btn-div border-green bg-green m-btn m-btn--icon m-btn--pill m-btn--wide">
                                            <span>+ <span></span></span>
                                          </div>
                                        </td>
                                      </table>
                ...
                <div class="row" id="contract-row-id">
                  ...
                  <div class="col-md-12">
                    <h3 class="kt-portlet__head-title head-title text-primary">Choose Contract For Down Payment</h3>
                  </div>
                  <div class="col-md-4">
                    <div class="form-group">
                      <label for="contracts">Contracts</label>
                      <select
                        :data-current-selected="model?.contractId ?? 0"
                        name="contract_id"
                        id="contract-id"
                        class="form-control ajax-get-purchases-orders-for-contract"
                      ></select>
                    </div>
                  </div>
                      ...
                      <div class="col-md-12 js-duplicate-node">
                        <div class="kt-margin-b-10 border-class">
                          <div class="form-group row align-items-end">
                            ...
                            <div class="col-md-2 closest-parent">
                              <label>Amount <span class="contract-currency"></span></label>
                              <div class="kt-input-icon">
                                <input
                            ...
                            <div class="col-md-2 closest-parent">
                              <label
                                >Paid Amount
                                <span class="contract-currency"></span>
                                <span class="text-danger required-label">*</span></label
                              >
                              <div class="kt-input-icon">
                                <input
                                  name="purchases_orders_amounts[][paid_amounts]"
                                  placeholder="Paid Amount"
                                  type="text"
                ...
                <div class="row">
                  ...
                  <div class="col-md-2 width-12 closest-parent">
                    <label class="label text-nowrap">Unapplied Amount <span class="taking-currency-span"></span></label>
                    <input
                      readonly
                      id="remaining-settlement-taking-js"
                      class="form-control"
                  ...
                  <div class="col-md-2 width-12 closest-parent">
                    <label class="label">Unapplied Amount <span class="invoice-currency-span"></span></label>
                    <input
                      readonly
                      id="remaining-settlement-js"
                      class="form-control"
                      placeholder="Unapplied Amount"
                      type="text"
            ...
            <div class="kt-portlet__body">
              <div class="form-group row">
                <div class="col-md-12">
                  ...
                  <textarea id="user-comment" v-model="userComment" class="form-control" name="user_comment"></textarea>
                </div>
              </div>
            </div>
          </div>
              ...
              <div class="kt-form__actions">
                <div class="row">
                  ...
                  <div class="col-lg-6 kt-align-right">
                    <a v-if="routes.viewMoneyPayment" :href="routes.viewMoneyPayment" class="btn active-style">Close</a>
