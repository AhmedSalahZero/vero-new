    ...
    <div class="mp-page kt-portlet kt-portlet--tabs">
      <div class="mp-header kt-portlet__head">
        <div class="kt-portlet__head-toolbar justify-content-between flex-grow-1">
          <ul class="nav nav-tabs nav-tabs-space-lg nav-tabs-line nav-tabs-bold nav-tabs-line-3x nav-tabs-line-brand" role="tablist">
            <li class="nav-item">
              <a onclick="return false" class="nav-link" :class="{ active: tabActive(MP.PAYABLE_CHEQUE) }" data-toggle="tab" :href="'#' + MP.PAYABLE_CHEQUE" role="tab">
                <i class="fa fa-money-check-alt"></i> Payable Cheques
              </a>
            </li>
            <li class="nav-item">
              <a onclick="return false" class="nav-link" :class="{ active: tabActive(MP.OUTGOING_TRANSFER) }" data-toggle="tab" :href="'#' + MP.OUTGOING_TRANSFER" role="tab">
                <i class="fa fa-money-check-alt"></i> Outgoing Transfer
              </a>
            </li>
            <li class="nav-item">
              <a onclick="return false" class="nav-link" :class="{ active: tabActive(MP.CASH_PAYMENT) }" data-toggle="tab" :href="'#' + MP.CASH_PAYMENT" role="tab">
                <i class="fa fa-money-check-alt"></i> Cash Payment
              </a>
            </li>
          </ul>
          <div v-if="canCreateSupplierPayment" class="flex-tabs">
            <Link :href="routes.createMoneyPayment" class="btn btn-sm active-style btn-icon-sm align-self-center">
              <i class="fas fa-plus"></i>
              Money Payment
            </Link>
            <Link :href="routes.createMoneyPaymentDownPayment" class="btn btn-sm active-style btn-icon-sm align-self-center">
              <i class="fas fa-plus"></i>
              Down Payment
            </Link>
          </div>
      ...
      <div class="kt-portlet__body">
        <div class="tab-content kt-margin-t-20">
          <!-- Payable Cheques -->
          <div class="tab-pane" :class="{ active: tabActive(MP.PAYABLE_CHEQUE) }" :id="MP.PAYABLE_CHEQUE" role="tabpanel">
            <div class="kt-portlet kt-portlet--mobile mp-card">
              <div class="kt-portlet__head kt-portlet__head--lg p-0">
                <div class="kt-portlet__head-label ml-4" style="flex: 2.5">
                  ...
                  <h3 style="font-size: 20px !important" class="kt-portlet__head-title text-main-color text-nowrap">Payable Cheques</h3>
                  <form class="w-full flex-2" method="get" :action="routes.viewMoneyPayment">
                    ...
                    <div class="row align-items-center">
                      <div class="col-md-3 d-flex align-items-center" style="margin-left: 5rem !important">
                        <label :for="'startDate_' + MP.PAYABLE_CHEQUE" class="text-nowrap mr-3">Start Date</label>
                        <input
                          :id="'startDate_' + MP.PAYABLE_CHEQUE"
                          type="date"
                          class="form-control"
                          :name="'startDate[' + MP.PAYABLE_CHEQUE + ']'"
                          :value="filterDates[MP.PAYABLE_CHEQUE]?.startDate || ''"
                        />
                      </div>
                      <div class="col-md-3 d-flex align-items-center">
                        <label :for="'endDate_' + MP.PAYABLE_CHEQUE" class="text-nowrap mr-3">End Date</label>
                        <input
                          :id="'endDate_' + MP.PAYABLE_CHEQUE"
                          type="date"
                          class="form-control"
                          :name="'endDate[' + MP.PAYABLE_CHEQUE + ']'"
                          :value="filterDates[MP.PAYABLE_CHEQUE]?.endDate || ''"
                        />
                      </div>
                      <div class="col-md-2 d-flex justify-content-center" style="margin-left: 2rem !important">
                        <label for="button"></label>
                        <button style="width: 70px !important; font-size: 1rem !important" type="submit" class="btn block form-control btn-primary btn-sm">Submit</button>
                      </div>
                    </div>
                  </form>
                </div>
                  ...
                  <div class="kt-portlet__head-wrapper">
                    <div class="kt-portlet__head-actions">
                      ...
                      >
                        ...
                        Create Batch Mark As Paid
                      </a>
                      <a
                        data-type="multi"
                        data-toggle="modal"
                        :data-target="'#search-money-modal-' + MP.PAYABLE_CHEQUE"
                        id="js-search-money-received"
                        href="#"
                        title="Search Money Payments"
                        class="btn active-style btn-icon-sm"
                      >
                        <i class="fas fa-search"></i>
                        Advanced Filter
                      </a>
                      <div class="modal fade" :id="'search-money-modal-' + MP.PAYABLE_CHEQUE" tabindex="-1" role="dialog" aria-hidden="true">
                        <div class="modal-dialog modal-xl" role="document">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <form :action="routes.viewMoneyPayment" class="row" method="get">
                                <input name="active" type="hidden" :value="MP.PAYABLE_CHEQUE" />
                                <div class="form-group col-4">
                                  ...
                                  <select
                                    ...
                                    name="field"
                                  >
                                    <option v-for="(label, name) in payableChequesTableSearchFields" :key="name" :value="name" :selected="requestQuery.field === name">
                                      {{ label }}
                                    </option>
                                  </select>
                                </div>
                                <div class="form-group col-4">
                                  ...
                                  <input name="value" type="text" :value="requestQuery.value || ''" placeholder="Search Text" class="form-control search-field" />
                                </div>
                                <div class="form-group col-2">
                                  <label class="label">From <span class="data-type-span">[ Receiving Date ]</span></label>
                                  <input name="from" type="date" :value="requestQuery.from || ''" class="form-control" />
                                </div>
                                <div class="form-group col-2">
                                  <label class="label">To <span class="data-type-span">[ Receiving Date ]</span></label>
                                  <input name="to" type="date" :value="requestQuery.to || ''" class="form-control" />
                                </div>
                                <div class="modal-footer">
                                  <button type="submit" :href="routes.viewMoneyReceive" id="js-search-id" class="btn btn-primary">Search</button>
                                  <button href="#" id="reset-search-id" type="button" class="btn btn-primary">Reset</button>
                                </div>
                              </form>
                            </div>
                          </div>
                      ...
                      <div class="modal fade" :id="'send-to-under-collection-modal' + MP.PAYABLE_CHEQUE" tabindex="-1" role="dialog" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                          <div class="modal-content">
                            <form
                              ...
                              :action="routes.payableChequeMarkAsPaid"
                              method="post"
                            >
                              <input type="hidden" :id="'single-or-multi' + MP.PAYABLE_CHEQUE" value="single" />
                              <input type="hidden" :id="'current-single-item' + MP.PAYABLE_CHEQUE" value="0" />
                              <input type="hidden" :id="'current-currency' + MP.PAYABLE_CHEQUE" class="current-currency" value="" />
                              <input type="hidden" name="_token" :value="csrfToken" />
                              <div class="modal-header">
                                <h5 class="modal-title">Do You Want To Mark This Cheque / Cheques As Paid ?</h5>
              ...
              <div class="kt-portlet__body">
                <table class="table  table-striped- table-bordered table-hover table-checkable text-center kt_table_1 mp-table">
                  <thead>
                    ...
                    <tr v-for="row in payableCheques.data" :key="row.id">
                      <td>
                        <input
                          ...
                          :id="'cash-send-to-collection' + row.id"
                          type="checkbox"
                          name="second_to_collection[]"
                          :value="row.id"
                          :data-money-type="MP.PAYABLE_CHEQUE"
                      ...
                      <td class="text-transform" :data-currency="row.currency">{{ row.currencyToPaymentCurrencyFormatted }}</td>
                      ...
                      <td class="font-weight-bold bank-max-width" :style="{ color: row.dueStatusColor + '!important' }">
                      ...
                      <td class="kt-datatable__cell--left kt-datatable__cell" data-field="Actions" data-autohide-disabled="false">
                        <span style="overflow: visible; position: relative; width: 110px">
                          <template v-if="row.hasComment">
                            <a
                              :data-toggle="'modal'"
                              :data-target="'#user-comment-' + row.id"
                              type="button"
                            ...
                            ></a>
                            <div class="modal fade" :id="'user-comment-' + row.id" tabindex="-1" role="dialog" aria-hidden="true">
                              <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                  <form action="#" method="post">
                                    ...
                                    <div class="modal-body">
                                      <h2 class="text-wrap" :class="row.userCommentIsArabic ? 'text-right' : 'text-left'">{{ row.userComment }}</h2>
                                    </div>
                                    <div class="modal-footer">
                                      <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                    </div>
                          ...
                          <template v-if="row.showOdooError">
                            <a
                              :data-toggle="'modal'"
                              :data-target="'#odoo-model-' + row.id"
                              type="button"
                              class="btn btn-icon bg-red text-white"
                              title="Odoo Error"
                              href="#"
                              ><i class="fa fa-bug"></i
                            ></a>
                            <div class="modal fade" :id="'odoo-model-' + row.id" tabindex="-1" role="dialog" aria-hidden="true">
                              <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
                                <div class="modal-content">
                                  <form :action="row.resendOdooUrl" method="post">
                                    ...
                                    <div class="modal-body">
                                      <h2 class="text-wrap" :class="row.odooErrorIsArabic ? 'text-right' : 'text-left'">{{ row.odooError }}</h2>
                                    </div>
                                    <div class="modal-footer">
                                      <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                          ...
                          <template v-if="row.showIntegratedModal">
                            ...
                            ></a>
                            <div class="modal fade" :id="'fully-integrated-id-' + row.id" tabindex="-1" role="dialog" aria-hidden="true">
                              <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                  <form action="#" method="post">
                                    <input type="hidden" name="_token" :value="csrfToken" />
                                    <div class="modal-header blue">
                                      <h5 class="modal-title text-blue">Odoo References</h5>
                                      <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                      </button>
                                    </div>
                                    <div class="modal-body">
                                      <ul class="list-unstyled">
                                        <li v-for="(ref, ri) in row.odooReferenceNames" :key="ri" class="mb-3 text-left">{{ ref }}</li>
                                      </ul>
                                    </div>
                                    <div class="modal-footer">
                          ...
                          <template v-if="canUpdateSupplierPayment">
                            <template v-if="row.showReviewModal">
                              ...
                              ></a>
                              <div class="modal fade" :id="'review-id-' + row.id" tabindex="-1" role="dialog" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                  <div class="modal-content">
                                    <form :action="row.confirmedReviewUrl" method="post">
                                      <input type="hidden" name="_token" :value="csrfToken" />
                                      <input type="hidden" name="model_name" :value="row.modelNameForReview" />
                                      <input type="hidden" name="table_name" :value="row.tableName" />
                                      <div class="modal-header">
                                        <h5 class="modal-title">Mark This As Reviewed ?</h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                          <span aria-hidden="true">&times;</span>
                                        </button>
                                      </div>
                            ...
                            <template v-if="!row.isOpenBalance">
                              <Link :href="row.editUrl" type="button" class="btn btn-secondary btn-outline-hover-brand btn-icon" title="Edit Cheque"
                            ...
                            <template v-else>
                              ...
                              ></a>
                              <div class="modal closest-parent-class editable-opening-balance-cheque fade" :id="'edit-opening-cheques' + row.id" tabindex="-1" role="dialog" aria-hidden="true">
                                <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
                                  <div class="modal-content">
                                    <form :action="row.updateOpeningPayableChequeUrl" method="post">
                                      <input type="hidden" name="_token" :value="csrfToken" />
                                      <input type="hidden" />
                                      <div class="modal-header">
                                        <h5 class="modal-title">Opening Payable Cheque Edit</h5>
                                        <button type="button" class="close" aria-label="Close">
                                          <span aria-hidden="true">&times;</span>
                                        </button>
                                      </div>
                                      <div class="modal-body">
                                        <div class="row mb-3">
                                          <div class="col-md-4">
                                            ...
                                            <div class="kt-input-icon">
                                              <div class="input-group date">
                                                ...
                                                >
                                                  <option v-for="(optLabel, optVal) in suppliersFormatted" :key="optVal" :value="optVal" :selected="String(optVal) === String(row.supplierId)">
                                                    {{ optLabel }}
                                                  </option>
                                                </select>
                                              </div>
                                          ...
                                          <div class="col-md-1">
                                            ...
                                            <div class="kt-input-icon">
                                              <div class="input-group date">
                                                <select name="currency" class="form-control select-for-currency-temp ajax-get-invoice-numbers" js-when-change-trigger-change-account-type>
                                                  <option
                                          ...
                                          <div class="col-md-1">
                                            ...
                                            <div class="kt-input-icon width-15">
                                              <div class="input-group">
                                                <input name="exchange_rate" type="numeric" class="form-control" :value="row.exchangeRate" />
                                              </div>
                                            </div>
                                          </div>
                                          <div class="col-md-2">
                                          ...
                                          <div class="col-md-2">
                                            ...
                                            <div class="kt-input-icon width-15">
                                              <div class="input-group">
                                                <input name="paid_amount" type="text" class="form-control" :value="row.paidAmountFormattedRaw" />
                                              </div>
                                            </div>
                                          </div>
                                          <div class="col-md-2">
                                            ...
                                            <div class="kt-input-icon width-15">
                                              <div class="input-group">
                                                <input name="cheque_number" type="text" class="form-control" :value="row.chequeNumber" />
                                              </div>
                                            </div>
                                          </div>
                                          <div class="col-md-6 mb-3 mt-3">
                                            <label>Drawal Bank <span class="text-danger required-label">*</span></label>
                                            <div class="kt-input-icon">
                                              <div class="input-group date">
                                                <select
                                            ...
                                            <div class="kt-input-icon">
                                              <div class="input-group date">
                                                <select name="account_type" class="form-control js-update-account-number-based-on-account-type">
                                                  ...
                                                  <option v-for="(at, ai) in accountTypes" :key="ai" :value="at.id" :selected="at.id === row.payableChequeAccountTypeId">
                                                    {{ at.name }}
                                                  </option>
                                                </select>
                                              </div>
                          ...
                          <template v-if="!row.isOpenBalance && canDeleteSupplierPayment">
                            <a
                              data-toggle="modal"
                              :data-target="'#delete-cheque-id-' + row.id"
                              type="button"
                              ...
                              <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                  ...
                                  >
                                    ...
                                    <div class="modal-header">
                                      <h5 class="modal-title" id="exampleModalLongTitle">Do You Want To Delete This Item ?</h5>
                                      <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                      </button>
                                    </div>
                ...
                <nav v-if="payableCheques.links && payableCheques.links.length" class="mp-pagination" aria-label="Pagination">
          ...
          <div class="tab-pane" :class="{ active: tabActive(MP.OUTGOING_TRANSFER) }" :id="MP.OUTGOING_TRANSFER" role="tabpanel">
            <div class="kt-portlet kt-portlet--mobile mp-card">
              <div class="kt-portlet__head kt-portlet__head--lg p-0">
                <div class="kt-portlet__head-label ml-4" style="flex: 2.5">
                  <span class="kt-portlet__head-icon">
                  ...
                  <h3 style="font-size: 20px !important" class="kt-portlet__head-title text-main-color text-nowrap">Outgoing Transfer</h3>
                  <form class="w-full flex-2" method="get" :action="routes.viewMoneyPayment">
                    <input type="hidden" name="active" :value="MP.OUTGOING_TRANSFER" />
                    <div class="row align-items-center">
                      <div class="col-md-3 d-flex align-items-center" style="margin-left: 5rem !important">
                        <label class="text-nowrap mr-3">Start Date</label>
                        <input type="date" class="form-control" :name="'startDate[' + MP.OUTGOING_TRANSFER + ']'" :value="filterDates[MP.OUTGOING_TRANSFER]?.startDate || ''" />
                      </div>
                      <div class="col-md-3 d-flex align-items-center">
                        <label class="text-nowrap mr-3">End Date</label>
                        <input type="date" class="form-control" :name="'endDate[' + MP.OUTGOING_TRANSFER + ']'" :value="filterDates[MP.OUTGOING_TRANSFER]?.endDate || ''" />
                      </div>
                      <div class="col-md-2 d-flex justify-content-center" style="margin-left: 2rem !important">
                        <button style="width: 70px !important; font-size: 1rem !important" type="submit" class="btn block form-control btn-primary btn-sm">Submit</button>
                      </div>
                ...
                <div class="kt-portlet__head-toolbar" style="flex: 1 !important">
                  <div class="kt-portlet__head-wrapper">
                    <div class="kt-portlet__head-actions">
                      &nbsp;
                      <a
                        :data-money-type="MP.OUTGOING_TRANSFER"
                        data-type="multi"
                        data-toggle="modal"
                      ...
                      <a data-type="multi" data-toggle="modal" :data-target="'#search-money-modal-' + MP.OUTGOING_TRANSFER" href="#" class="btn active-style btn-icon-sm">
                        <i class="fas fa-search"></i>
                        Advanced Filter
                      </a>
                      <div class="modal fade" :id="'search-money-modal-' + MP.OUTGOING_TRANSFER" tabindex="-1" role="dialog" aria-hidden="true">
                        <div class="modal-dialog modal-xl" role="document">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h5 class="modal-title">Filter Form</h5>
                            ...
                            <div class="modal-body">
                              <form :action="routes.viewMoneyPayment" class="row" method="get">
                                <input name="active" type="hidden" :value="MP.OUTGOING_TRANSFER" />
                                <div class="form-group col-4">
                                  <label class="label">Field Name</label>
                                  <select :data-type="MP.OUTGOING_TRANSFER" class="form-control js-search-modal" name="field">
                                    <option v-for="(label, name) in outgoingTransferTableSearchFields" :key="name" :value="name" :selected="requestQuery.field === name">{{ label }}</option>
                                  </select>
                                </div>
                                <div class="form-group col-4">
                                  <label class="label">Search Text</label>
                                  <input name="value" type="text" :value="requestQuery.value || ''" class="form-control search-field" />
                                </div>
                                <div class="form-group col-2">
                                  <label class="label">From <span class="data-type-span">[ Receiving Date ]</span></label>
                                  <input name="from" type="date" :value="requestQuery.from || ''" class="form-control" />
                                ...
                                <div class="modal-footer">
                                  ...
                                  <button id="reset-search-id" type="button" class="btn btn-primary">Reset</button>
                                </div>
                              </form>
                            </div>
                          </div>
                      ...
                      <div class="modal fade" :id="'send-to-under-collection-modal' + MP.OUTGOING_TRANSFER" tabindex="-1" role="dialog" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                          <div class="modal-content">
                            <form
                              :data-money-type="MP.OUTGOING_TRANSFER"
                              ...
                              class="ajax-send-cheques-to-collection"
                              :action="routes.outgoingTransferMarkAsPaid"
                              method="post"
                            >
                              <input type="hidden" :id="'single-or-multi' + MP.OUTGOING_TRANSFER" value="single" />
                              <input type="hidden" :id="'current-single-item' + MP.OUTGOING_TRANSFER" value="0" />
                              <input type="hidden" :id="'current-currency' + MP.OUTGOING_TRANSFER" class="current-currency" value="" />
                              <input type="hidden" name="_token" :value="csrfToken" />
                              <div class="modal-header">
                                <h5 class="modal-title">Do You Want To Mark This Outcoming Transfer/s As Paid ?</h5>
                              ...
                              <div class="modal-body">
                                <div class="row mb-3">
                                  <div class="col-md-12">
                                    ...
                                    <div class="kt-input-icon">
                                      <div class="input-group date">
                                        <input required type="text" name="actual_payment_date" class="form-control" readonly placeholder="Select date" />
                                        <div class="input-group-append">
              ...
              <div class="kt-portlet__body">
                <table class="table  table-striped- table-bordered table-hover table-checkable text-center kt_table_1 mp-table">
                  ...
                  <tbody>
                    <tr v-for="row in outgoingTransfer.data" :key="row.id">
                      ...
                      <td>{{ row.paidAmountFormatted }}</td>
                      <td :data-currency="row.currency">{{ row.currencyToPaymentCurrencyFormatted }}</td>
                      <td class="bank-max-width">{{ row.outgoingTransferAccountTypeName }}</td>
                      <td>{{ row.outgoingTransferAccountNumber }}</td>
                      <td class="kt-datatable__cell--left kt-datatable__cell" data-field="Actions" data-autohide-disabled="false">
                        <span style="overflow: visible; position: relative; width: 110px">
                          <template v-if="row.hasComment">
                            <a :data-toggle="'modal'" :data-target="'#user-comment-ot-' + row.id" type="button" class="btn btn-secondary btn-outline-hover-success btn-icon" href="#"><i class="fa fa-comment"></i></a>
                            <div class="modal fade" :id="'user-comment-ot-' + row.id" tabindex="-1" role="dialog" aria-hidden="true">
                              <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                  <form action="#" method="post">
                                    <input type="hidden" name="_token" :value="csrfToken" />
                          ...
                          <template v-if="row.showOdooError">
                            <a :data-toggle="'modal'" :data-target="'#odoo-model-ot-' + row.id" type="button" class="btn btn-icon bg-red text-white" href="#"><i class="fa fa-bug"></i></a>
                            <div class="modal fade" :id="'odoo-model-ot-' + row.id" tabindex="-1" role="dialog" aria-hidden="true">
                              <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
                                <div class="modal-content">
                                  <form :action="row.resendOdooUrl" method="post">
                                    <input type="hidden" name="_token" :value="csrfToken" />
                          ...
                          <template v-if="row.showIntegratedModal">
                            <a :data-toggle="'modal'" :data-target="'#fully-integrated-ot-' + row.id" type="button" class="btn btn-primary btn-icon" href="#"><i class="fa fa-thumbs-up"></i></a>
                            <div class="modal fade" :id="'fully-integrated-ot-' + row.id" tabindex="-1" role="dialog" aria-hidden="true">
                              <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                  <form action="#" method="post">
                                    <input type="hidden" name="_token" :value="csrfToken" />
                          ...
                          <template v-if="!row.isOpenBalance && canUpdateSupplierPayment">
                            <template v-if="row.showReviewModal">
                              <a :data-toggle="'modal'" :data-target="'#review-ot-' + row.id" type="button" class="btn btn-secondary btn-outline-hover-success btn-icon" href="#"><i class="fa fa-check"></i></a>
                              <div class="modal fade" :id="'review-ot-' + row.id" tabindex="-1" role="dialog" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                  <div class="modal-content">
                                    <form :action="row.confirmedReviewUrl" method="post">
                                      <input type="hidden" name="_token" :value="csrfToken" />
                            ...
                            <Link :href="row.editUrl" type="button" class="btn btn-secondary btn-outline-hover-brand btn-icon" title="Edit"><i class="fa fa-pen-alt"></i></Link>
                          </template>
                          <template v-if="!row.isOpenBalance && canDeleteSupplierPayment">
                            <a data-toggle="modal" :data-target="'#delete-transfer-id-' + row.id" type="button" class="btn btn-secondary btn-outline-hover-danger btn-icon" title="Delete" href="#"><i class="fa fa-trash-alt"></i></a>
                            <div
                              class="modal fade"
                              :id="'delete-transfer-id-' + row.id"
                              tabindex="-1"
                              role="dialog"
                              aria-labelledby="exampleModalCenterTitle"
                              aria-hidden="true"
                            >
                              <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                  <form onsubmit="this.querySelector('button[type=submit]').disabled = true;" :action="row.deleteUrl" method="post">
                                    <input type="hidden" name="_token" :value="csrfToken" />
                                    <input type="hidden" name="_method" value="delete" />
                                    <div class="modal-header">
                                      <h5 class="modal-title" id="exampleModalLongTitle">Do You Want To Delete This Item ?</h5>
                ...
                <nav v-if="outgoingTransfer.links && outgoingTransfer.links.length" class="mp-pagination" aria-label="Pagination">
          ...
          <!-- Cash Payment -->
          <div class="tab-pane" :class="{ active: tabActive(MP.CASH_PAYMENT) }" :id="MP.CASH_PAYMENT" role="tabpanel">
            <div class="kt-portlet kt-portlet--mobile mp-card">
              <div class="kt-portlet__head kt-portlet__head--lg p-0">
                <div class="kt-portlet__head-label ml-4" style="flex: 2.5">
                  <span class="kt-portlet__head-icon">
                  ...
                  <h3 style="font-size: 20px !important" class="kt-portlet__head-title text-main-color text-nowrap">Cash Payment</h3>
                  <form class="w-full flex-2" method="get" :action="routes.viewMoneyPayment">
                    <input type="hidden" name="active" :value="MP.CASH_PAYMENT" />
                    <div class="row align-items-center">
                      <div class="col-md-3 d-flex align-items-center" style="margin-left: 5rem !important">
                        <label class="text-nowrap mr-3">Start Date</label>
                        <input type="date" class="form-control" :name="'startDate[' + MP.CASH_PAYMENT + ']'" :value="filterDates[MP.CASH_PAYMENT]?.startDate || ''" />
                      </div>
                      <div class="col-md-3 d-flex align-items-center">
                        <label class="text-nowrap mr-3">End Date</label>
                        <input type="date" class="form-control" :name="'endDate[' + MP.CASH_PAYMENT + ']'" :value="filterDates[MP.CASH_PAYMENT]?.endDate || ''" />
                      </div>
                      <div class="col-md-2 d-flex justify-content-center" style="margin-left: 2rem !important">
                        <button style="width: 70px !important; font-size: 1rem !important" type="submit" class="btn block form-control btn-primary btn-sm">Submit</button>
                      </div>
                ...
                <div class="kt-portlet__head-toolbar" style="flex: 1 !important">
                  <div class="kt-portlet__head-wrapper">
                    <div class="kt-portlet__head-actions">
                      &nbsp;
                      <a data-type="multi" data-toggle="modal" :data-target="'#search-money-modal-' + MP.CASH_PAYMENT" href="#" class="btn active-style btn-icon-sm">
                        <i class="fas fa-search"></i>
                        Advanced Filter
                      </a>
                      <div class="modal fade" :id="'search-money-modal-' + MP.CASH_PAYMENT" tabindex="-1" role="dialog" aria-hidden="true">
                        <div class="modal-dialog modal-xl" role="document">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h5 class="modal-title">Filter Form</h5>
                            ...
                            <div class="modal-body">
                              <form :action="routes.viewMoneyPayment" class="row" method="get">
                                <input name="active" type="hidden" :value="MP.CASH_PAYMENT" />
                                <div class="form-group col-4">
                                  <label class="label">Field Name</label>
                                  <select :data-type="MP.CASH_PAYMENT" class="form-control js-search-modal" name="field">
                                    <option v-for="(label, name) in payableCashTableSearchFields" :key="name" :value="name" :selected="requestQuery.field === name">{{ label }}</option>
                                  </select>
                                </div>
                                <div class="form-group col-4">
                                  <label class="label">Search Text</label>
              ...
              <div class="kt-portlet__body">
                  ...
                  <tbody>
                    <tr v-for="row in cashPayments.data" :key="row.id">
                      ...
                      <td class="kt-datatable__cell--left kt-datatable__cell" data-field="Actions" data-autohide-disabled="false">
                        <span style="overflow: visible; position: relative; width: 110px">
                          <template v-if="row.hasComment">
                            <a :data-toggle="'modal'" :data-target="'#user-comment-cp-' + row.id" type="button" class="btn btn-secondary btn-outline-hover-success btn-icon" href="#"><i class="fa fa-comment"></i></a>
                            <div class="modal fade" :id="'user-comment-cp-' + row.id" tabindex="-1" role="dialog" aria-hidden="true">
                              <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                  <form action="#" method="post">
                                    <input type="hidden" name="_token" :value="csrfToken" />
                          ...
                          <template v-if="row.showOdooError">
                            <a :data-toggle="'modal'" :data-target="'#odoo-model-cp-' + row.id" type="button" class="btn btn-icon bg-red text-white" href="#"><i class="fa fa-bug"></i></a>
                            <div class="modal fade" :id="'odoo-model-cp-' + row.id" tabindex="-1" role="dialog" aria-hidden="true">
                              <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
                                <div class="modal-content">
                                  <form :action="row.resendOdooUrl" method="post">
                                    <input type="hidden" name="_token" :value="csrfToken" />
                          ...
                          <template v-if="row.showIntegratedModal">
                            <a :data-toggle="'modal'" :data-target="'#fully-integrated-cp-' + row.id" type="button" class="btn btn-primary btn-icon" href="#"><i class="fa fa-thumbs-up"></i></a>
                            <div class="modal fade" :id="'fully-integrated-cp-' + row.id" tabindex="-1" role="dialog" aria-hidden="true">
                              <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                  <form action="#" method="post">
                                    <input type="hidden" name="_token" :value="csrfToken" />
                          ...
                          <template v-if="!row.isOpenBalance && canUpdateSupplierPayment">
                            <template v-if="row.showReviewModal">
                              <a :data-toggle="'modal'" :data-target="'#review-cp-' + row.id" type="button" class="btn btn-secondary btn-outline-hover-success btn-icon" href="#"><i class="fa fa-check"></i></a>
                              <div class="modal fade" :id="'review-cp-' + row.id" tabindex="-1" role="dialog" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                  <div class="modal-content">
                                    <form :action="row.confirmedReviewUrl" method="post">
                                      <input type="hidden" name="_token" :value="csrfToken" />
                ...
                <nav v-if="cashPayments.links && cashPayments.links.length" class="mp-pagination" aria-label="Pagination">
