													...
													<tbody>
														<tr v-if="paginatedRows.length === 0">
															<td colspan="9" class="text-center py-5">
																...
																<p class="text-muted">{{ $t('No Tradings found') }}
																</p>
															</td>
														</tr>
...
const deleteRow = async (rowId) => {
	...
	const deleteUrl = `${baseUrl}/${lang}/${companyId}/property-managements/Tradings/${propertyId}/property-expenses/${rowId}/destroy`
...
const getModelData = () => {
	...
	const fetchOldDataUrl = `${baseUrl}/${lang}/${companyId}/property-managements/Tradings/${propertyId}/property-expenses-old-data`
	axios
		.get(fetchOldDataUrl, {
			headers: {
				'X-CSRF-TOKEN': csrfToken,
