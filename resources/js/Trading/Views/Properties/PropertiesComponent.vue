...
const getModelData = () => {
	...
	const fetchOldDataUrl = `${baseUrl}/${lang}/${companyId}/property-managements/Tradings/Tradings-old-data${propertyId ? '?property_id=' + propertyId : '?type=' + propertyType}`
	...
	axios
		...
		.then((response) => {
			...
			if (!propertyId && propertyType) {
				...
				// For existing Tradings, get type from nature_id
