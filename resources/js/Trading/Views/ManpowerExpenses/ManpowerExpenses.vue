...
<template>
	...
	<div v-if="!isLoading">
		...
		<div class="kt-portlet" v-for="(department, index) in departmentWithPositions" :key="index">
				...
				<div class="row">
					...
					<div class="col-md-1">
						<div class="d-flex justify-content-end">
							<div @click="showAndHide.departments[index] = !showAndHide.departments[index]"
        ...
        > -->
				<div v-show="showAndHide.departments[index]" class="row mt-4">
					<div class="col-md-12 overflow-scroll">
							...
							<thead>
								<tr>
									...
									<th
										...
										<span class="text-center d-inline-block">Existing <br /> Count </span>
									</th>
									<th
										class="form-label expandable-th-amount-input font-weight-bold text-center align-middle header-border-down">
										<span class="text-center d-inline-block">Monthly Net <br /> Salary </span>
									</th>
									<template v-for="(dateFormatted, dateAsIndex) in dates" :key="dateAsIndex">
										...
										" class="form-label expandable-th-amount-input font-weight-bold text-center align-middle header-border-down">
											<div class="d-flex justify-content-center align-items-center"
												style="gap: 10px">
												<span class="text-center d-inline-block">Total Yr. <br />
                        ...
                        style="visibility: hidden"></i> -->
							...
							<tbody v-if="!isLoading">
								<tr v-for="(position, positionIndex) in department.positions" :key="positionIndex"
									...
									<td>
										<div class="d-flex flex-column align-items-start">
											<InputNumber v-model="model.manpowers[position.id].existing_count" :min="0"
									...
									<td>
										<div class="d-flex flex-column align-items-start">
											<InputNumber v-model="model.manpowers[position.id].monthly_net_salary"
									...
									<template v-for="(dateFormatted, dateAsIndex) in dates" :key="dateAsIndex">
										<td v-if="!hideTablesDates.departments[index].includes(Number(dateAsIndex))">
											...
											<div class="d-flex flex-column align-items-center">
												<InputNumber
													...
													:min="0" input-class="text-center" :minFractionDigits="0"
													:maxFractionDigits="0" suffix="" fluid />
												<i @click="
													handleRepeatRight(
										...
										<td v-if="
											...
											lastMonthIndexInEachYear.length > 1
										">
											<InputNumber v-model="manpowerHiringTotals.subRowTotals[position.id]['per_year'][dateAsIndex]
												" :min="0" input-class="text-center" :minFractionDigits="0" :maxFractionDigits="2" suffix=""
												disabled fluid />
											<i style="visibility: hidden" class="fa fa-ellipsis-h"></i>
										</td>
										<!--  end Total Yr. 2026 for example -->
									...
									<td>
										<InputNumber v-model="manpowerHiringTotals.subRowTotals[position.id]['total']"
											:min="0" input-class="text-center" :minFractionDigits="0"
											:maxFractionDigits="2" suffix="" disabled fluid />
										<i style="visibility: hidden" class="fa fa-ellipsis-h"></i>
									</td>
								</tr>
								<!-- end total row -->
