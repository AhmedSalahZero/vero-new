...
const getModelData = () => {
	...
	const fetchOldDataUrl = `${baseUrl}/${lang}/${companyId}/property-managements/study/${studyId}/occupied-properties-with-full-rent-coverage-duration-old-data`
	axios
		.get(fetchOldDataUrl, {
			headers: {
						...
						<table class="table">
							...
							<tbody>
								<tr v-for="(property, propertyIndex) in model.properties" :data-repeater-style="true">
									<td>
										<div class="d-flex w-auto flex-column align-items-center">
