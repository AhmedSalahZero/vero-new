...
const getModelData = () => {
	...
	const fetchOldDataUrl = `${baseUrl}/${lang}/${companyId}/property-managements/study/${studyId}/occupied-properties-with-partial-rent-coverage-duration-old-data`
	axios
		.get(fetchOldDataUrl, {
			headers: {
					...
					<div class="col-md-11">
						<div class="d-flex align-items-center">
							<h3 class="font-weight-bold form-label kt-subheader__title small-caps">
								{{ $t('Partial Rent Coverage Duration & Vacant Properties') }}
							</h3>
						</div>
					</div>
					<div class="col-md-1">
