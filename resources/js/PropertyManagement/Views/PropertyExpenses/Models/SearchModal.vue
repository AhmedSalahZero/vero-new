			...
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title">
						<i class="fa fa-search"></i> {{ $t('Search Properties') }}
					</h5>
				...
				<div class="modal-body">
					<div class="form-group">
						...
						<select v-model="searchField" class="form-control">
							<option value="expense_category_name">{{ $t('Expense Category') }}</option>
							<option value="expense_name">{{ $t('Expense Name') }}</option>
							<option value="date">{{ $t('Date') }}</option>
							<option value="is_paid">{{ $t('Is Paid') }}</option>
							<option value="payment_date">{{ $t('Paid Date') }}</option>
