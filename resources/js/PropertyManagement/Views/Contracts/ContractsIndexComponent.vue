...
import DeleteConfirmModal from '../Properties/Components/Modals/DeleteConfirmModal.vue'
import SearchModal from '../Properties/Components/Modals/SearchModal.vue'
	...
	<div v-if="!contractStore.isLoading" class="kt-portlet kt-portlet--tabs">
		<div class="kt-portlet__head">
			<div class="kt-portlet__head-toolbar justify-content-between flex-grow-1">
				...
				<div class="flex-tabs">
					<button @click="handleBackToProperties"
