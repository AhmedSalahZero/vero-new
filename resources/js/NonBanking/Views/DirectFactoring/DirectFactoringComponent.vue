...
const updateLoanPercentage = (breakdownIndex, dateAsIndex, newLoanAmount) => {
...
const netDisbursements = computed(() => model.value?.netDisbursements)
...
const {
  ...
  newLoansTotals,
} = useNewLoanFundingCalculator(model, dates, netDisbursements, lastMonthIndexInEachYear)
              ...
              <thead>
                <tr>
                  ...
                  <template
                    ...
                    <template
                      v-if="
                        !hideTablesDates.directFactoringBreakdownsRef.includes(Number(dateAsIndex))
                      ">
                      <th
                        class="form-label expandable-th-amount-input font-weight-bold text-center align-middle header-border-down">
                        <span class="text-left d-inline-block">{{ dateFormatted }}</span>
                ...
                <template
                  ...
                  <tr
                    ...
                    <template
                      ...
                      <td
                        v-if="
                          !hideTablesDates.directFactoringBreakdownsRef.includes(
                            Number(dateAsIndex),
                          )
                        ">
                        <!-- {{ logRender(leasingRevenueStreamBreakdownItem.id, dateAsIndex) }} -->
                        <div
                          ...
                          <InputNumber
                            ...
                            @update:model-value="
                              (newValue) => updateLoanPercentage(index, dateAsIndex, newValue)
                            "
                            :min="0"
                            input-class="text-center"
                            :minFractionDigits="0"
