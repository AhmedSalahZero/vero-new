...
import { objectAsStringAndNumberInterface } from '../../../Helpers/Type'
// properties
...
const hasLeasing = ref(false)
const hasFactoring = ref(false)
const hasMortgage = ref(false)
const hasMicrofinance = ref(false)
const hasConsumerFinance = ref(false)
const getModelData = () => {
  ...
  const fetchOldDataUrl = `${baseUrl}/${lang}/${companyId}/non-banking-financial-services/study/${studyId}/general-and-reserve-assumption-old-data`
  axios
    .get(fetchOldDataUrl, {
      headers: {
    ...
    .then((response) => {
      ...
      hasLeasing.value = response.data.hasLeasing
      hasFactoring.value = response.data.hasFactoring
      hasMortgage.value = response.data.hasMortgage
      hasMicrofinance.value = response.data.hasMicrofinance
      hasConsumerFinance.value = response.data.hasConsumerFinance
  ...
  <div v-if="!isLoading">
    ...
    <div class="kt-portlet">
      <div class="kt-portlet__body">
        <div class="row">
          ...
          <div class="col-md-1">
            <div class="d-flex justify-content-end">
              <div
                @click="showAndHide.reserve_assumption = !showAndHide.reserve_assumption"
        ...
        <div
          v-show="showAndHide.reserve_assumption"
          class="row mt-4">
          <div class="col-md-3">
            <Label> Legal Reserve Rate % </Label>
            <InputNumber
              v-model="model.legal_reserve_rate"
              :min="0"
              :max="100"
              :minFractionDigits="2"
              :maxFractionDigits="5"
          ...
          <div class="col-md-3">
            ...
            <InputNumber
              v-model="model.max_legal_reserve_rate"
              :min="0"
              :max="100"
              :minFractionDigits="2"
              :maxFractionDigits="5"
          ...
          <div class="col-md-3">
            ...
            <InputNumber
              v-model="model.financial_regulatory_authority_rate"
              :min="0"
              :max="100"
              :minFractionDigits="2"
              :maxFractionDigits="5"
          ...
          <div class="col-md-3">
            ...
            <InputNumber
              v-model="model.max_financial_regulatory_authority_rate"
              :min="0"
              :max="100"
              :minFractionDigits="2"
              :maxFractionDigits="5"
      ...
      <div class="kt-portlet__body">
        <div class="row">
          ...
          <div class="col-md-1">
            <div class="d-flex justify-content-end">
              <div
                @click="showAndHide.profit_assumptions = !showAndHide.profit_assumptions"
                class="btn show-hide-style">
                Show/Hide
              </div>
            </div>
        ...
        <div
          v-show="showAndHide.profit_assumptions"
          class="row mt-4">
            ...
            <table class="table">
              <thead>
                <tr>
                  ...
                  <template
                    v-for="(yearFormatted, yearIndex) in years"
                    :key="yearIndex">
                    <!-- <template> -->
                    <th
              ...
              <tbody>
                ...
                <tr :data-repeater-style="true">
                  <td>
                    <div class="d-flex flex-column align-items-start">
                      <input
                        :value="'Employee Profit Share Rate'"
                        :disabled="true"
                  ...
                  <template
                    ...
                    <td>
                      <div
                        ...
                        <InputNumber
                          v-model="model.employee_profit_share_rates[yearIndex]"
                          :min="0"
                          :max="100"
                          input-class="text-center min-w-percentage"
                          :minFractionDigits="2"
                          :maxFractionDigits="5"
                          suffix=" %"
                          fluid />
                ...
                <tr :data-repeater-style="true">
                  <td>
                    <div class="d-flex flex-column align-items-start">
                      <input
                        :value="'Board Of Directors Profit Share Rates'"
                        :disabled="true"
                        class="form-control min-width-300 text-left mt-2"
                        type="text" />
                      <i
                ...
                <tr :data-repeater-style="true">
                  <td>
                    <div class="d-flex flex-column align-items-start">
                      <input
                        :value="'Shareholders First Dividend Portion'"
                        :disabled="true"
                        class="form-control min-width-300 text-left mt-2"
                        type="text" />
                      <i
                ...
                <tr :data-repeater-style="true">
                  <td>
                    <div class="d-flex flex-column align-items-start">
                      <input
                        :value="'Shareholders Dividend Payout Ratio %'"
                        :disabled="true"
                        class="form-control min-width-300 text-left mt-2"
                        type="text" />
                      <i
                ...
                <tr :data-repeater-style="true">
                  <td>
                    <div class="d-flex flex-column align-items-start">
                      <input
                        :value="'Shareholders Dividend (In Cash Or Shares)'"
                        :disabled="true"
                        class="form-control min-width-300 text-left mt-2"
                        type="text" />
                      <i
      ...
      <div class="kt-portlet__body">
        <div class="row">
          <div class="col-md-11">
            <div class="d-flex align-items-center">
              <h3 class="font-weight-bold form-label kt-subheader__title small-caps">
                CBE Corridor & Banks Lending Margins & Interest Rates
              </h3>
            </div>
          </div>
          <div class="col-md-1">
            <div class="d-flex justify-content-end">
              <div
                @click="showAndHide.bank_lending = !showAndHide.bank_lending"
                class="btn show-hide-style">
                Show/Hide
              </div>
            </div>
        ...
        <div
          v-show="showAndHide.bank_lending"
          class="row mt-4">
          <div class="col-md-12 overflow-scroll">
            <table class="table">
              <thead>
                <tr>
                  ...
                  <template
                    ...
                    <template v-if="!hideTablesDates.bank_lending.includes(Number(dateAsIndex))">
                      <th
                        class="form-label expandable-percentage-input font-weight-bold text-center align-middle header-border-down">
                        <span class="text-center d-inline-block">{{ dateFormatted }} <br /> </span>
                      </th>
                    </template>
                    <!--  start Total Yr. 2026 for example -->
                    <th
                      ...
                      <div
                        ...
                        <i
                          @click="hideOrExpandMyYear('bank_lending', Number(dateAsIndex))"
                          :title="'Expand / Collapse'"
                          class="cursor-pointer fa fa-expand-arrows-alt text-primary exclude-icon"></i>
                      </div>
                    </th>
              ...
              <tbody>
                ...
                <tr :data-repeater-style="true">
                  ...
                  <template
                    ...
                    <td v-if="!hideTablesDates.bank_lending.includes(Number(dateAsIndex))">
                      ...
                      <div class="d-flex flex-column align-items-center">
                        <InputNumber
                          v-model="model.cbe_corridor_changes_rates[dateAsIndex]"
                          :min="-100"
                          :max="100"
                          input-class="text-center"
                          :minFractionDigits="2"
                ...
                <tr :data-repeater-style="true">
                  <td>
                    <div class="d-flex flex-column align-items-start">
                      <input
                        :value="'Net CBE Lending Corridor %'"
                        :disabled="true"
                        class="form-control min-width-300 text-left mt-2"
                        type="text" />
                      <i
                  ...
                  <template
                    ...
                    <td v-if="!hideTablesDates.bank_lending.includes(Number(dateAsIndex))">
                      ...
                      <div class="d-flex flex-column align-items-center">
                        <InputNumber
                          :disabled="true"
                          v-model="getCbeLendingCorridorRates[dateAsIndex]"
                          :min="0"
                          :max="100"
                          input-class="text-center"
                          :minFractionDigits="2"
                ...
                <tr
                  ...
                  <td>
                    <div class="d-flex flex-column align-items-start">
                      <input
                        :value="'Leasing MTLs Banks Lending Margin %'"
                        :disabled="true"
                        class="form-control min-width-300 text-left mt-2"
                        type="text" />
                      <i
                  ...
                  <template
                    ...
                    <td v-if="!hideTablesDates.bank_lending.includes(Number(dateAsIndex))">
                      ...
                      <div class="d-flex flex-column align-items-center">
                        <InputNumber
                          v-model="model.bank_lending_margin_rates.leasing[dateAsIndex]"
                          :min="0"
                          :max="100"
                          input-class="text-center"
                          :minFractionDigits="2"
                        ...
                        <i
                          @click="
                            handleRepeatRight(
                              model.bank_lending_margin_rates.leasing,
                              dateAsIndex,
                              dates,
                            )
                          "
                ...
                <tr
                  ...
                  <td>
                    <div class="d-flex flex-column align-items-start">
                      <input
                        :value="'Factoring MTLs Banks Lending Margin %'"
                        :disabled="true"
                        class="form-control min-width-300 text-left mt-2"
                        type="text" />
                      <i
                  ...
                  <template
                    ...
                    <td v-if="!hideTablesDates.bank_lending.includes(Number(dateAsIndex)) && model">
                      <div class="d-flex flex-column align-items-center">
                        <InputNumber
                          v-model="model.bank_lending_margin_rates.factoring[dateAsIndex]"
                          :min="0"
                          :max="100"
                          input-class="text-center"
                          :minFractionDigits="2"
                        ...
                        <i
                          @click="
                            handleRepeatRight(
                              model.bank_lending_margin_rates.factoring,
                              dateAsIndex,
                              dates,
                            )
                          "
                ...
                <tr
                  ...
                  <td>
                    <div class="d-flex flex-column align-items-start">
                      <input
                        :value="'Mortgage MTLs Banks Lending Margin %'"
                        :disabled="true"
                        class="form-control min-width-300 text-left mt-2"
                        type="text" />
                      <i
                  ...
                  <template
                    ...
                    <td v-if="!hideTablesDates.bank_lending.includes(Number(dateAsIndex))">
                      <div class="d-flex flex-column align-items-center">
                        <InputNumber
                          v-model="model.bank_lending_margin_rates.mortgage[dateAsIndex]"
                          :min="0"
                          :max="100"
                          input-class="text-center"
                          :minFractionDigits="2"
                        ...
                        <i
                          @click="
                            handleRepeatRight(
                              model.bank_lending_margin_rates.mortgage,
                              dateAsIndex,
                              dates,
                            )
                          "
                ...
                <tr
                  v-if="hasMicrofinance"
                  :data-repeater-style="true">
                  <td>
                    <div class="d-flex flex-column align-items-start">
                      <input
                        :value="'Microfinance MTLs Banks Lending Margin %'"
                        :disabled="true"
                        class="form-control min-width-300 text-left mt-2"
                        type="text" />
                      <i
                  ...
                  <template
                    ...
                    <td v-if="!hideTablesDates.bank_lending.includes(Number(dateAsIndex)) && model">
                      <div class="d-flex flex-column align-items-center">
                        <InputNumber
                          v-model="model.bank_lending_margin_rates.microfinance[dateAsIndex]"
                          :min="0"
                          :max="100"
                          input-class="text-center"
                          :minFractionDigits="2"
                        ...
                        <i
                          @click="
                            handleRepeatRight(
                              model.bank_lending_margin_rates.microfinance,
                              dateAsIndex,
                              dates,
                            )
                          "
                ...
                <tr :data-repeater-style="true">
                  <td>
                    <div class="d-flex flex-column align-items-start">
                      <input
                        :value="'ODAs Banks Lending Margin Rate %'"
                        :disabled="true"
                        class="form-control min-width-300 text-left mt-2"
                        type="text" />
                      <i
                  ...
                  <template
                    ...
                    <td v-if="!hideTablesDates.bank_lending.includes(Number(dateAsIndex)) && model">
                      <div class="d-flex flex-column align-items-center">
                        <InputNumber
                          v-model="model.odas_bank_lending_margin_rates[dateAsIndex]"
                          :min="0"
                          :max="100"
                          input-class="text-center"
                          :minFractionDigits="2"
                ...
                <tr
                  v-if="hasConsumerFinance"
                  :data-repeater-style="true">
                  <td>
                    <div class="d-flex flex-column align-items-start">
                      <input
                        :value="'Consumer MTLs Banks Lending Margin %'"
                        :disabled="true"
                        class="form-control min-width-300 text-left mt-2"
                        type="text" />
                      <i
                  ...
                  <template
                    ...
                    <td v-if="!hideTablesDates.bank_lending.includes(Number(dateAsIndex))">
                      <div class="d-flex flex-column align-items-center">
                        <InputNumber
                          v-model="model.bank_lending_margin_rates.consumer[dateAsIndex]"
                          :min="0"
                          :max="100"
                          input-class="text-center"
                          :minFractionDigits="2"
                        ...
                        <i
                          @click="
                            handleRepeatRight(
                              model.bank_lending_margin_rates.consumer,
                              dateAsIndex,
                              dates,
                            )
                          "
                ...
                <tr :data-repeater-style="true">
                  <td>
                    <div class="d-flex flex-column align-items-start">
                      <input
                        :value="'Credit Interest Rate For Surplus Cash %'"
                        :disabled="true"
                        class="form-control min-width-300 text-left mt-2"
                        type="text" />
                      <i
      ...
      <div class="kt-portlet__body">
        <div class="row">
          ...
          <div class="col-md-1">
            <div class="d-flex justify-content-end">
              <div
                @click="showAndHide.min_cash_balance_policy = !showAndHide.min_cash_balance_policy"
                class="btn show-hide-style">
                Show/Hide
              </div>
            </div>
        ...
        <div
          v-show="showAndHide.min_cash_balance_policy"
          class="row mt-4">
          <div class="col-md-12 overflow-scroll">
            <table class="table">
              <thead>
              ...
              <tbody>
                <tr :data-repeater-style="true">
                  ...
                  <td>
                    <div class="d-flex flex-column align-items-center">
                      <Select
                        filter
                        v-model="model.from_dispersement_of"
                        :options="dispersementOfOptions"
                        optionLabel="title"
                        optionValue="id"
                        placeholder=""
                        checkmark
                  ...
                  <template
                    ...
                    <td
                      v-if="!hideTablesDates.min_cash_balance_policy.includes(Number(dateAsIndex))">
                      <!-- {{ logRender(leasingRevenueStreamBreakdownItem.id, dateAsIndex) }} -->
                      <div class="d-flex flex-column mx-auto min-w-percentage align-items-center">
                        <InputNumber
                          v-model="model.from_dispersement_of_rates[dateAsIndex]"
                          :min="0"
                          :max="100"
                          input-class="text-center"
                          :minFractionDigits="2"
                        ...
                        <i
                          @click="
                            handleRepeatRight(model.from_dispersement_of_rates, dateAsIndex, dates)
                          "
                          class="fa fa-ellipsis-h row-repeater-icon cursor-pointer"
                          title="Repeat Right"></i>
                      </div>
                ...
                <tr :data-repeater-style="true">
                  <td>
                    <div class="d-flex flex-column align-items-center">
                      <input
                        :value="'As Percentage Of All Cost & Expenses'"
                        :disabled="true"
                        class="form-control min-width-300 text-left mt-2"
                        type="text" />
                      <i
                  ...
                  <template
                    ...
                    <td
                      ...
                      <div class="d-flex mx-auto flex-column min-w-percentage align-items-center">
                        <InputNumber
                          v-model="model.to_cover_cost_rates[dateAsIndex]"
                          :min="0"
                          :max="100"
                          input-class="text-center"
                          :minFractionDigits="2"
                          ...
                          fluid />
                        <i
                          @click="handleRepeatRight(model.to_cover_cost_rates, dateAsIndex, dates)"
                          class="fa fa-ellipsis-h row-repeater-icon cursor-pointer"
                          title="Repeat Right"></i>
                      </div>
                    </td>
                  ...
                  <template
                    ...
                    <td
                      ...
                      <div class="d-flex flex-column max-w-175 align-items-center">
                        <InputNumber
                          v-model="model.min_cash_balances[dateAsIndex]"
                          :min="0"
                          input-class="text-center"
                          :minFractionDigits="0"
                          :maxFractionDigits="0"
                          ...
                          fluid />
                        <i
                          @click="handleRepeatRight(model.min_cash_balances, dateAsIndex, dates)"
                          class="fa fa-ellipsis-h row-repeater-icon cursor-pointer"
                          title="Repeat Right"></i>
                      </div>
                    </td>
                    ...
                    <td
                      ...
                      ">
                      <InputText
                        :value="minCashBalanceTotal.subRowTotals.per_year[dateAsIndex]"
                        class="text-center"
                        disabled
                        fluid />
                      <i
