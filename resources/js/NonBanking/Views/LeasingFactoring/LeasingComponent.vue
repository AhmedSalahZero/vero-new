...
const {
  ...
  newLoansTotals,
} = useNewLoanFundingCalculator(model, dates, totalPerColumns, lastMonthIndexInEachYear)
                ...
                <tr
                  ...
                  <td>
                    <InputNumber
                      ...
                      :min="leasingRevenueStreamBreakdownItem.grace_period + 1"
                  ...
                  <td>
                    <InputNumber
                      ...
                      :min="0"
                      :max="leasingRevenueStreamBreakdownItem.tenor - 1"
                      input-class="text-center"
                      :minFractionDigits="0"
                      :maxFractionDigits="0"
                      fluid />
              ...
              <thead>
                <tr>
                  ...
                  <template
                    ...
                    :key="dateAsIndex">
                    <template v-if="!hideTablesDates.loansTableRef.includes(Number(dateAsIndex))">
                      <th
                    ...
                    <th
                      ...
                      <div
                        ...
                        <i
                          @click="hideOrExpandMyYear('loansTableRef', Number(dateAsIndex))"
                ...
                <template
                  ...
                  <tr
                    ...
                    <template
                      v-for="(dateFormatted, dateAsIndex) in dates"
                      :key="dateAsIndex">
                      <td v-if="!hideTablesDates.loansTableRef.includes(Number(dateAsIndex))">
