    ...
    <div class="kt-portlet__head">
        <div class="kt-portlet__head-toolbar justify-content-between flex-grow-1">
            ...
            <div class="flex-tabs">
                ...
                <a href="{{ route('property.management.create.expense.names',['company'=>$company->id]) }}" class="btn btn-2-bg bg-white-hover new-study-item rounded btn-icon-sm align-self-center">
                            ...
                            <tr class="group-color main-row-tr">
                                ...
                                <td class="text-left text-capitalize">
                                    ...
                                    <b class="ml-3">
                                        ...
                                        <a type="button" class="btn btn-secondary btn-outline-hover-brand btn-icon" title="Edit" href="{{ route('property.management.edit.expense.names', ['company'=>$company->id,'expenseType'=>$parent['name']]) }}"><i class="fa exclude-icon fa-pen-alt"></i></a>
                                        ...
                                        <div id="modal-delete-{{ $mainItemId }}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="{{ route('property.management.expense.names.destroy',['company'=>$company->id , 'expenseType'=> $parent['name'] ]) }}" method="post" id="delete_form">
                                                        {{ csrf_field() }}
                                                        {{ method_field('DELETE') }}
