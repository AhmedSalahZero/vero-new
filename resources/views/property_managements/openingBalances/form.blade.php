                ...
                <div class="row opening-balances-row">
                    ...
                    <div class="form-group row" style="flex:1;">
                        <div class="col-md-12 mt-3" data-repeater-row=".opening-balances-row">
                            ...
                            <form class="kt-form kt-form--label-right" action="{{ route('store.opening.balances.for.property.management',['company'=>$company->id , 'study'=>$study->id]) }}" method="POST">
                                {{ csrf_field() }}
							@include('property_managements.openingBalances._content',$study->getOpeningBalancesViewVars())
