...
<form action="{{ route('property.management.save.manual.equity.injection',['company'=>$company->id,'study'=>$study->id]) }}" method="post">
@csrf
    ...
    <div class="kt-portlet__body">
        <div class="tab-content  kt-margin-t-20">
            ...
            <!--Begin:: Tab Content-->
            @include('property_managements.income-statement._odas')
