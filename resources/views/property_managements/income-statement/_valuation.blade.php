            ...
            <td>
                <div class="d-flex align-items-center ">
                    ...
                    {{-- <div>
                        ...
                        @include('property_managements.income-statement._expense-modal',['currentModalId'=>$currentModalId,'modalTitle'=>$currentModalTitle,'modalData'=>$formattedDcfMethod[$key] ?? []])
                    </div> --}}
