                                ...
                                <tr>
                                    ...
                                    <td class="kt-datatable__cell--left kt-datatable__cell" data-field="Actions" data-autohide-disabled="false">
                                        ...
                                        <span style="overflow: visible; position: relative; width: 110px;">
                                            ...
                                            <a data-toggle="modal" data-target="#apply-deposit-modal-{{ $model->id }}" type="button" class="btn @if($model->isDueTodayOrGreater()) disabled @endif btn-secondary btn-outline-hover-success btn-icon" title="{{ __('Apply Deposit') }}" href="#"><i class="fa fa-coins"></i></a>
