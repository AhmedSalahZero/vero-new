    ...
    <div class="kt-portlet__head">
        <div class="kt-portlet__head-toolbar justify-content-between flex-grow-1">
            ...
            <div class="flex-tabs">
                ...
                <a href="{{ route('trading.create.tenants',['company'=>$company->id]) }}" class="btn btn-2-bg bg-white-hover new-study-item rounded btn-icon-sm align-self-center">
                ...
                <div class="kt-portlet kt-portlet--mobile">
                        ...
                        <x-table :tableClass="'kt_table_with_no_pagination_no_fixed  removeGlobalStyle ' ">
                            ...
                            <tr class="group-color main-row-tr">
								...
								<td class="text-left text-capitalize">
									<b class="ml-3">
										{{ getBusinessSectors()[$tenant->getBusinessSector()] }}
									</b>
								</td>
								<td class="text-left text-capitalize">
									<b class="ml-3">
										{{ $tenant->getRelatedParty() }}
									</b>
								</td>
                                ...
                                <td class="text-left text-capitalize">
                                    ...
                                    <b class="ml-3">
                                        ...
                                        <a type="button" class="btn btn-secondary btn-outline-hover-brand btn-icon" title="Edit" href="{{ route('trading.edit.tenants', ['company'=>$company->id,'tenant'=>$tenant->id]) }}"><i class="fa exclude-icon fa-pen-alt"></i></a>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h4 class="modal-title">{{ __('Delete Tenant ' . str_to_upper($tenant->getName()) ) }}</h4>
                                                    </div>
                                                    <div class="modal-body">
                                                        <h3>{{ __('Are You Sure To Delete This Item ? ') }}</h3>
                                                    </div>
                                                    <form action="{{ route('trading.tenants.destroy',['company'=>$company->id , 'tenant'=> $tenant->id ]) }}" method="post" id="delete_form">
                                                        @csrf
                                                        {{ method_field('DELETE') }}
