                    ...
                    <div class="tab-pane active" id="FullySecuredOverdraftchartkt_apps_contacts_view_tab_1" role="tabpanel">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8 mb-3">
								...
								@if($withSensitivity)
                                <a href="{{ route('trading.view.results.dashboard',['company'=>$company,'study'=>$study->id]) }}" class="btn btn-sm btn-brand btn-elevate btn-pill text-white" >{{ __('Reset Sensitivity') }}</a>
								@endif 
                                @include('tradings.dashboard._spread-rate-sensitivity-modal',['currentModalId'=>$currentModalId,'modalTitle'=>$currentModalTitle])
                            </div>
		

                            @include('tradings.dashboard._income-statement')
							@if($withSensitivity)
							
                            @include('tradings.dashboard._income-statement',['formattedResult'=>$sensitivityFormattedResult])
                            ...
                            @include('tradings.dashboard._income-statement-percentage-of',['formattedResult'=>$formattedResult])
							
							@if($withSensitivity)
                            @include('tradings.dashboard._income-statement-percentage-of',['formattedResult'=>$sensitivityFormattedResult])
							@endif 
            ...
            <div class="kt-portlet__body pt-0">
                ...
                <div class="tab-content  kt-margin-t-20">
                    ...
                    <div class="tab-pane active" id="FullySecuredOverdraftchartkt_apps_contacts_view_tab_1" role="tabpanel">
                       ...
                       @include('tradings.dashboard._expenses',['formattedExpenses'=>$formattedExpenses])
					   @if($withSensitivity)
                       @include('tradings.dashboard._expenses',['formattedExpenses'=>$sensitivityFormattedExpenses])
					   
					   @endif 

                       @include('tradings.dashboard._expenses-percentage-of',['formattedExpenses'=>$formattedExpenses])

					   @if($withSensitivity)
                       @include('tradings.dashboard._expenses-percentage-of',['formattedExpenses'=>$sensitivityFormattedExpenses])
					   @endif 
