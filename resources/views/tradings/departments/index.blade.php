        ...
        <div class="kt-portlet__head-toolbar justify-content-between flex-grow-1">
            ...
            {{-- @if(auth()->user()->can('create study info')) --}}
			 ...
			 <div class="flex-tabs">
                ...
                <a href="{{ route('trading.create.departments',['company'=>$company->id,'type'=>'general']) }}" class="btn btn-2-bg bg-white-hover new-study-item rounded btn-icon-sm align-self-center">
									 ...
									 <td>
									  ...
									  <td class="kt-datatable__cell--left kt-datatable__cell " data-field="Actions" data-autohide-disabled="false">
                                        <span style="overflow: visible; position: relative; width: 110px;">
                                            ...
                                            <a type="button" class="btn btn-secondary btn-outline-hover-brand btn-icon edit-btn-class" title="{{ __('Edit') }}" href="{{ route('trading.edit.departments',['company'=>$company->id,'department'=>$model->id,'type'=>$currentType]) }}"><i class="fa fa-pen-alt exclude-icon default-icon-color" ></i></a>
                                            ...
                                            <div class="modal fade" id="delete-department-{{ $model->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        <form action="{{ route('trading.departments.destroy',['company'=>$company->id,'department'=>$model->id ]) }}" method="post">
                                                            @csrf
                                                            @method('delete')
