...
<head>
  ...
  <title>Foxic HTML Template - Index Page - Medical</title>
  ...
  <link href="{{url("front/css/style-medical.css")}}" rel="stylesheet">
  <!-- Custom font -->
...
<body class="has-round-btns template-collection has-smround-btns has-loader-bg equal-height has-sm-container" >
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-auto hdr-logo">
            <a href="{{url("front/index.html")}}" class="logo"><img srcset="{{url("front/images/skins/medical/logo-medical.png 1x")}}, {{url("front/images/skins/medical/logo-medical2x.png 2x")}}" alt="Logo"></a>
          </div>
          <!--navigation-->
          ...
          <div class="hdr-links-wrap col-auto ml-auto">
            <div class="hdr-inline-link">
              ...
              <div class="dropdn dropdn_wishlist">
                <a href="{{url("front/account-wishlist.html")}}" class="dropdn-link only-icon wishlist-link ">
      ...
      <div class="hdr-content">
        <div class="container">
          <div class="row">
            ...
            <div class="col-auto hdr-logo">
              <a href="index.html" class="logo"><img srcset="{{url("front/images/skins/medical/logo-medical.png 1x")}}, {{url("front/images/skins/medical/logo-medical2x.png 2x")}}" alt="Logo"></a>
            </div>
            <!--navigation-->
            <div class="hdr-nav hide-mobile nav-holder justify-content-center">
              ...
              <ul class="mmenu mmenu-js">
                <li><a href="{{route('front.home')}}" class="no-uppercase" style="color:#78cb36"><span>{{__("HOME")}}</span></a></li>
                @foreach ($categories as $category)
                    <li class="mmenu-item--simple"><a href="{{route('front.category',[$category])}}" class="active no-uppercase"><span>{{$category->name[$lang]}}</span></a>
                        <div class="mmenu-submenu d-flex">
                            <ul class="submenu-list mt-0">
                                @foreach ($category->products as $product)
                                    <li><a href="{{route('front.product',[$category,$product])}}">{{$product->name[$lang]}}</a></li>
                                @endforeach
                            {{-- <li><a href="#">Vaping Skin <span class="menu-label">Coming Soon</span></a><span class="submenu-link-image"><img src="{{url("front/images/screen/screen-vaping.png")}}" alt=""></span></li> --}}
                            {{-- </ul>
                            <ul class="submenu-list mt-0">
                            <li><a href="index-02.html">Home page 2</a><span class="submenu-link-image"><img src="{{url("front/images/screen/screen02.png")}}" alt=""></span></li>
                            <li><a href="index-03.html">Home page 3</a><span class="submenu-link-image"><img src="{{url("front/images/screen/screen03.png")}}" alt=""></span></li>
                            <li><a href="index-04.html">Home page 4</a><span class="submenu-link-image"><img src="{{url("front/images/screen/screen04.png")}}" alt=""></span></li>
                            <li><a href="index-05.html">Home page 5</a><span class="submenu-link-image"><img src="{{url("front/images/screen/screen05.png")}}" alt=""></span></li>
                            <li><a href="index-06.html">Home page 6</a><span class="submenu-link-image"><img src="{{url("front/images/screen/screen06.png")}}" alt=""></span></li>
                            <li><a href="index-07.html">Home page 7</a><span class="submenu-link-image"><img src="{{url("front/images/screen/screen07.png")}}" alt=""></span></li>
                            <li><a href="index-08.html">Home page 8</a><span class="submenu-link-image"><img src="{{url("front/images/screen/screen08.png")}}" alt=""></span></li>
                            <li><a href="index-09.html">Home page 9</a><span class="submenu-link-image"><img src="{{url("front/images/screen/screen09.png")}}" alt=""></span></li>
                            <li><a href="index-10.html">Home page 10</a><span class="submenu-link-image"><img src="{{url("front/images/screen/screen10.png")}}" alt=""></span></li>
                            <li><a href="index-rtl.html">Home page RTL</a><span class="submenu-link-image"><img src="{{url("front/images/screen/screen-rtl.png")}}" alt=""></span></li>
                            </ul> --}}
                        </div>
                    </li>
                @endforeach
                        ...
                        <div class="mmenu-left width-25">
                          <div class="mmenu-bnr-wrap">
                            <a href="product.html" class="image-hover-scale image-container w-100" style="padding-bottom: 102.91%">
                              <img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-srcset="{{url("front/images/skins/medical/menu/mmenu-bnr-01.png")}}" class="lazyload fade-up" alt="">
                            </a>
                          </div>
            ...
            <div class="mobilemenu-language">
              ...
              <div class="dropdn_language">
                <div class="dropdn dropdn_language dropdn_language--noimg dropdn_caret">
                  ...
                  <div class="dropdn-content">
                    <ul>
                      <li class="active"><a href="#"><img src="{{url("front/images/flags/en.png")}}" alt="">English</a></li>
                      <li><a href="#"><img src="{{url("front/images/flags/sp.png")}}" alt="">Spanish</a></li>
                      <li><a href="#"><img src="{{url("front/images/flags/de.png")}}" alt="">German</a></li>
                      <li><a href="#"><img src="{{url("front/images/flags/fr.png")}}" alt="">French</a></li>
                    </ul>
                  </div>
                </div>
              </div>
        ...
        <div class="minicart-drop-content js-dropdn-content-scroll">
          <div class="minicart-prd row">
            <div class="minicart-prd-image image-hover-scale-circle col">
              <a href="product.html"><img class="lazyload fade-up" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="{{url("front/images/skins/fashion/products/product-01-1.jpg")}}" alt=""></a>
            </div>
          ...
          <div class="minicart-prd row">
            <div class="minicart-prd-image image-hover-scale-circle col">
              <a href="product.html"><img class="lazyload fade-up" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="{{url("front/images/skins/fashion/products/product-16-1.jpg")}}" alt=""></a>
            </div>
            <div class="minicart-prd-info col">
              <div class="minicart-prd-tag">FOXic</div>
            ...
            <div class="footer-block collapsed-mobile">
              ...
              <div class="collapsed-content">
                <div class="footer-newsletter">
                  <form action="#">
                    <div class="form-group">
                      <input type="text" class="form-control form-control--sm" placeholder="Enter your E-mail">
                    </div>
                    <div class="form-group">
      ...
      <div class="container">
        <div class="row">
          <div class="col-auto sticky-addcart_image">
            <a href="product.html">
              <img src="{{url("front/images/skins/fashion/products/product-01-1.jpg")}}" alt="" />
            </a>
          </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-auto popup-addedtocart_logo">
            <img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="{{url("images/logo-white-sm.png")}}" class="lazyload fade-up" alt="">
          </div>
            ...
            <div class="row">
              <a href="product.html" class="col-auto popup-addedtocart_image">
                <span class="image-container w-100">
                  <img src="{{url("images/skins/fashion/products/product-01-1.jpg")}}" alt="" />
                </span>
              </a>
        ...
        <div class="payment-notification-inside">
          <div class="payment-notification-container">
            <a href="#" class="payment-notification-image js-pn-link">
              <img src="{{url("images/products/product-01.jpg")}}" class="js-pn-image" alt="">
            </a>
  ...
  <script src="{{url("front/js/vendor-special/lazysizes.js")}}"></script>
