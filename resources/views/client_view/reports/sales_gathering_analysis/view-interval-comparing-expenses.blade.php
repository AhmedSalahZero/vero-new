...
<div class="row">
    <div class="col-md-12">
        ...
        <!--begin::Form-->
        <form class="kt-form kt-form--label-right" method="POST" action="{{ $submitRoute  }}"   enctype="multipart/form-data">
            @csrf
                ...
                <div class="kt-portlet__body">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="kt-input-icon">
                                <div class="input-group date">
                                    <input type="date" name="start_date_one"  required value="{{ getEndYearBasedOnDataUploadedFromExpense($company)['jan'] }}"  class="form-control"  placeholder="Select date" />
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            ...
                            <div class="kt-input-icon">
                                <div class="input-group date">
                                    <input type="date" name="end_date_one"   required value="{{ getEndYearBasedOnDataUploadedFromExpense($company)['dec'] }}" max="{{date('Y-m-d')}}"  class="form-control"  placeholder="Select date" />
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                    ...
                    <div class="form-group row ">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="kt-input-icon">
                                <div class="input-group date">
                                    <input type="date" name="start_date_two"  required value="{{ getEndYearBasedOnDataUploadedFromExpense($company,1)['jan'] }}"  class="form-control"  placeholder="Select date" />
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            ...
                            <div class="kt-input-icon">
                                <div class="input-group date">
                                    <input type="date" name="end_date_two"  required  value="{{ getEndYearBasedOnDataUploadedFromExpense($company,1)['dec'] }}" max="{{date('Y-m-d')}}"  class="form-control"  placeholder="Select date" />
                                </div>
                            </div>
                        </div>
