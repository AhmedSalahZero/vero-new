                                    ...
                                    <div class="accordion accordion-toggle-arrow" id="veroanalysisId">
                                        ...
                                        <div class="card">
                                            ...
                                            <div id="collapseNonbankingserviceSection" class="collapse" aria-labelledby="headingOne" data-parent="#nonbankingserviceSection">
                                                <div class="card-body with-padding">
                                                    {{-- @can('view income statement planning') --}}
                                                    <x-quick-nav :link="route('non.banking.view.study', ['company'=>$company->id ])">{{ __('Go To Studies') }}</x-quick-nav>
                                                    {{-- @endcan --}}
                                        ...
                                        @endif
										  ...
										  @if($company->hasPropertyManagement())
                                        <div class="card">
                                            <div class="card-header" id="property-management">
                                                <div class="card-title collapsed" data-toggle="collapse" data-target="#collapseproperty-management" aria-expanded="true" aria-controls="collapseOne4">
                                                    <i class="flaticon2-layers-1"></i> {{ __('Property Management') }}
                                                </div>
                                            </div>
                                            <div id="collapseproperty-management" class="collapse" aria-labelledby="headingOne" data-parent="#property-management">
                                                <div class="card-body with-padding">
                                                    {{-- @can('view income statement planning') --}}
                                                    <x-quick-nav :link="route('property.management.view.study', ['company'=>$company->id ])">{{ __('Go To Studies') }}</x-quick-nav>
                                                    {{-- @endcan --}}
