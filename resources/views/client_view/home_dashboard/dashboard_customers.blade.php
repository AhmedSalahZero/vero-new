            ...
            <div class="kt-portlet__body">
                ...
                <x-table :tableClass="'kt_table_with_no_pagination_no_scroll'">
                    ...
                    <tr>
                        ...
                        <th>
                            <p style="max-width:125px">{{\App\Helpers\HVero::getCustomerNature($item->customer_name , $customers_natures) }}</p>
                            {{-- <span></span> --}}
                        </th>
                ...
                <div class="kt-portlet__body table-responsive">
                    <table class="table exclude-table text-center text-capitalize" style="background: #086691;color: #fff;font-weight: bold;">
                        ...
                        @foreach(\App\Helpers\HVero::getSummaryCustomerDashboardForEachType($allFormattedWithOthers , $customers_natures) as $arrKey=> $data )
                        @if($arrKey)
                        <tr>
