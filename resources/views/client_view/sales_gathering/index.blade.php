...
@endphp
{!! $generator->getBarcode(strtoupper(preg_replace('/[^A-Z0-9\-\.\ \$\/\+\%]/', '', $generateCode)), "C39", 3, 33) !!}
     ...
     src="data:image/png;base64,{!! base64_encode(QrCode::format('png')->size(120)->generate($generateCode)) !!}" 
     alt="barcode" />
