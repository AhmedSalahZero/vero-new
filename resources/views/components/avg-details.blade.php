										...
										@endphp
											 ...
											 class="btn @if(!count($currentDates) || (isset($reportData['report_data'][$mainItemName][$itemName]['dates']) && !count($reportData['report_data'][$mainItemName][$itemName]['dates']))) visibility-hidden @endif btn-sm btn-brand btn-elevate btn-pill text-white" data-toggle="modal" data-target="#{{ $currentModalId }}">{{ __('Details') }}</button>
