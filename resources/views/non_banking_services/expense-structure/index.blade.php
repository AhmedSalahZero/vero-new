    ...
    <div class="kt-portlet__head">
        <div class="kt-portlet__head-toolbar justify-content-between flex-grow-1">
            <ul class="nav nav-tabs nav-tabs-space-lg nav-tabs-line nav-tabs-bold nav-tabs-line-3x nav-tabs-line-brand" role="tablist">
                <li class="nav-item">
                    <a onclick="return false" class="nav-link {{ !Request('active') || Request('active') == ExpenseName::EXPENSE ?'active':'' }}" data-toggle="tab" href="#{{ExpenseName::EXPENSE  }}" role="tab">
                                        ...
                                        <div id="modal-delete-{{ $mainItemId }}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="{{ route('non.banking.expense.names.destroy',['company'=>$company->id , 'expenseType'=> $parent['name'] ]) }}" method="post" id="delete_form">
                                                        {{ csrf_field() }}
                                                        {{ method_field('DELETE') }}
