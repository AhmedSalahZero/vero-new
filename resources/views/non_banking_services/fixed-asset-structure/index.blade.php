        ...
        <div class="kt-portlet__head-toolbar justify-content-between flex-grow-1">
            ...
            {{-- @if(auth()->user()->can('create study info')) --}}
			 ...
			 <div class="flex-tabs">
                ...
                <a href="{{ route('non.banking.create.fixed.asset.names',['company'=>$company->id]) }}" class="btn btn-2-bg bg-white-hover new-study-item rounded btn-icon-sm align-self-center">
                                    ...
                                    <td>
									  ...
									  <td class="kt-datatable__cell--left kt-datatable__cell " data-field="Actions" data-autohide-disabled="false">
                                        <span style="overflow: visible; position: relative; width: 110px;">
                                            ...
                                            {{-- <a type="button" class="btn btn-secondary btn-outline-hover-brand btn-icon copy-btn-class" title="{{ __('Copy') }}" href="{{ route('non.banking.edit.study',['company'=>$company->id,'study'=>$model->id]) }}"><i class="fa fa-layer-group exclude-icon default-icon-color" ></i></a> --}}
											{{-- @endif  --}}
                                            ...
                                            <div class="modal fade" id="delete-fixed-asset-{{ $model->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        <form action="{{ route('non.banking.destroy.fixed.asset.names',['company'=>$company->id,'fixedAssetName'=>$model->id ]) }}" method="post">
                                                            @csrf
                                                            @method('delete')
