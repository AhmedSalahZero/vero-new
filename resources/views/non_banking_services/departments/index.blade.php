        ...
        <div class="kt-portlet__head-toolbar justify-content-between flex-grow-1">
            ...
            {{-- @if(auth()->user()->can('create study info')) --}}
			 ...
			 <div class="flex-tabs">
                ...
                <a href="{{ route('non.banking.create.departments',['company'=>$company->id,'type'=>'general']) }}" class="btn btn-2-bg bg-white-hover new-study-item rounded btn-icon-sm align-self-center">
                                            ...
                                            <div class="modal fade" id="delete-department-{{ $model->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        <form action="{{ route('non.banking.departments.destroy',['company'=>$company->id,'department'=>$model->id ]) }}" method="post">
                                                            @csrf
                                                            @method('delete')
