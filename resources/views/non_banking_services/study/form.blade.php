...
<div class="row">
    <div class="col-md-12">
        ...
        <form id="form-id" class="kt-form kt-form--label-right" method="POST" enctype="multipart/form-data" action="{{  isset($model) ? route('non.banking.update.study',[$company->id , $model->id]) : $storeRoute  }}">
            @csrf
            @if(isset($model))
            @method('put')
            @endif
