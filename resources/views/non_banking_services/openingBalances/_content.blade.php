...
@php
$repeaterId = 'longTermInvestmentsOpeningBalances';
...
<div class="div-title">
    {{ __('Right Of Use Assets') }}
</div>
@php
$repeaterId = 'rightOfUseAssetOpeningBalances';
$hiringPopModels[] = $repeaterId;
@endphp
<div class="formItem repeater{{ $repeaterId }}">
        ...
        <div data-repeater-item class="container parent-for-salary-amount">
            ...
            <div class="modal fade" id="modal-{{ $repeaterId }}-{{ $currentRowIndex }}" tabindex="-1" role="dialog" aria-labelledby="modalLabel-{{ $repeaterId }}-{{ $currentRowIndex }}" aria-hidden="true">
                <div class="modal-dialog modal-full" role="document">
                    <div class="modal-content">
                        <div class="modal-header header-border">
                            <h5 class="modal-title font-size-1rem text-blue" id="modalLabel-{{ $repeaterId }}">{{ __('Amortization') }}</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
...
<div class="formItem repeater{{ $repeaterId }}">
    ...
    <div data-repeater-list="{{ $repeaterId }}">
        ...
        <div class="row closest-parent pb-2 mt-4 col-12">
            ...
            <div class="modal fade" id="modal-non-performing-interests-customer-{{ $repeaterId }}-{{ $currentRowIndex }}" tabindex="-1" role="dialog" aria-labelledby="modalLabel-{{ $repeaterId }}-{{ $currentRowIndex }}" aria-hidden="true">
                <div class="modal-dialog modal-full" role="document">
                    <div class="modal-content">
                        <div class="modal-header header-border">
                            <h5 class="modal-title font-size-1rem text-blue" id="modalLabel-{{ $repeaterId }}">{{ __('Portfolio Interest') }}</h5>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-group text-center">
                                                <label>{{ $dateFormatted }}</label>
                                                <div class="ml-2">
                                                    <input class="form-control input-border" data-main-category="{{ $repeaterId }}" data-sub-category="non_performing_interests" data-last-index="{{ $dateAsIndex }}" name="[non_performing_interests]" multiple value="{{ $model ? $model->getNonPerformingInterestAtDateIndex($dateAsIndex):0 }}">
                                                </div>
                                            </div>
                                        </td>
                                        @endforeach
            ...
            <div class="modal fade" id="modal-non-performing-{{ $repeaterId }}-{{ $currentRowIndex }}" tabindex="-1" role="dialog" aria-labelledby="modalLabel-{{ $repeaterId }}-{{ $currentRowIndex }}" aria-hidden="true">
                <div class="modal-dialog modal-full" role="document">
                    <div class="modal-content">
                        <div class="modal-header header-border">
                            <h5 class="modal-title font-size-1rem text-blue" id="modalLabel-{{ $repeaterId }}">{{ __('Portfolio Principle') }}</h5>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-group text-center">
                                                <label>{{ $dateFormatted }}</label>
                                                <div class="ml-2">
                                                    <input class="form-control input-border" data-main-category="{{ $repeaterId }}" data-sub-category="non_performing_payload" data-last-index="{{ $dateAsIndex }}" name="[non_performing_payload]" multiple value="{{ $cashAndBank ? $cashAndBank->getNonPerformingPayloadAtDateIndex($dateAsIndex):0 }}">
                                                </div>
                                            </div>
                                        </td>
                                        @endforeach
...
<div class="div-title">
    {{ __('Lease Rent Liability') }}
</div>
@php
$repeaterId = 'leaseRentLiabilityOpeningBalances';
$hiringPopModels[] = $repeaterId;
@endphp
<div class="formItem repeater{{ $repeaterId }}">
        ...
        <div data-repeater-item class="container parent-for-salary-amount">
            ...
            <div class="modal fade" id="modal-{{ $repeaterId }}-{{ $currentRowIndex }}" tabindex="-1" role="dialog" aria-labelledby="modalLabel-{{ $repeaterId }}-{{ $currentRowIndex }}" aria-hidden="true">
                <div class="modal-dialog modal-full" role="document">
                    <div class="modal-content">
                        <div class="modal-header header-border">
                            <h5 class="modal-title font-size-1rem text-blue" id="modalLabel-{{ $repeaterId }}">{{ __('Rent Payment') }}</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-group text-center">
                                                <label>{{ $dateFormatted }}</label>
                                                <div class="ml-2">
                                                    <input class="form-control input-border" data-main-category="{{ $repeaterId }}" data-sub-category="rent_payment" data-last-index="{{ $dateAsIndex }}" name="[rent_payment]" multiple value="{{ $model ? $model->getRentPaymentAtDateIndex($dateAsIndex):0 }}">
                                                </div>
                                            </div>
                                        </td>
                                        @endforeach
            ...
            <div class="modal fade" id="modal-interest-{{ $repeaterId }}-{{ $currentRowIndex }}" tabindex="-1" role="dialog" aria-labelledby="modalLabel-{{ $repeaterId }}-{{ $currentRowIndex }}" aria-hidden="true">
                <div class="modal-dialog modal-full" role="document">
                    <div class="modal-content">
                        <div class="modal-header header-border">
                            <h5 class="modal-title font-size-1rem text-blue" id="modalLabel-{{ $repeaterId }}">{{ __('Interest') }}</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-group text-center">
                                                <label>{{ $dateFormatted }}</label>
                                                <div class="ml-2">
                                                    <input class="form-control input-border" data-main-category="{{ $repeaterId }}" data-sub-category="rent_interest" data-last-index="{{ $dateAsIndex }}" name="[rent_interest]" multiple value="{{ $model ? $model->getRentInterestAtDateIndex($dateAsIndex):0 }}">
                                                </div>
                                            </div>
                                        </td>
                                        @endforeach
                ...
                <div class="col-2 common-parent">
                    ...
                    <div class="modal fade" id="modal-for-retained-amounts" tabindex="-1" role="dialog" aria-labelledby="modalLabel-{{ $repeaterId }}-{{ $currentRowIndex }}" aria-hidden="true">
                        <div class="modal-dialog modal-full" role="document">
                            <div class="modal-content">
                                <div class="modal-header header-border">
                                    <h5 class="modal-title font-size-1rem text-blue" id="modalLabel-{{ $repeaterId }}">{{ __('Retained Earnings Dividends Distribution [ Dividends Amount ]') }}</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group text-center">
                                                        <label>{{ $dateFormatted }}</label>
                                                        <div class="ml-2">
                                                            <input class="form-control input-border" data-main-category="{{ $repeaterId }}" data-sub-category="retained_earning_distribution_amounts" data-last-index="{{ $dateAsIndex }}" name="[retained_earning_distribution_amounts]" multiple value="{{ $model ? $model->getRetainedEarningDistributionAmountsAtYearOrMonthIndex($dateAsIndex):0 }}">
                                                        </div>
                                                    </div>
                                                </td>
                                                @endforeach
                                ...
                                <div class="modal-header header-border">
                                    <h5 class="modal-title font-size-1rem text-blue">{{ __('Retained Earnings Dividends Distribution [ Dividends Payment ]') }}</h5>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group text-center">
                                                        <label>{{ $dateFormatted }}</label>
                                                        <div class="ml-2">
                                                            <input class="form-control input-border" data-main-category="{{ $repeaterId }}" data-sub-category="retained_earning_distribution_payments" data-last-index="{{ $dateAsIndex }}" name="[retained_earning_distribution_payments]" multiple value="{{ $model ? $model->getRetainedEarningDistributionPaymentsAtYearOrMonthIndex($dateAsIndex):0 }}">
                                                        </div>
                                                    </div>
                                                </td>
                                                @endforeach
