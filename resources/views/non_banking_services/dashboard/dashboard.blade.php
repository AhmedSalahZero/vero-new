                    ...
                    <div class="tab-pane active" id="FullySecuredOverdraftchartkt_apps_contacts_view_tab_1" role="tabpanel">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8 mb-3">
								...
								@if($withSensitivity)
                                <a href="{{ route('non.banking.view.results.dashboard',['company'=>$company,'study'=>$study->id]) }}" class="btn btn-sm btn-brand btn-elevate btn-pill text-white" >{{ __('Reset Sensitivity') }}</a>
								@endif 
